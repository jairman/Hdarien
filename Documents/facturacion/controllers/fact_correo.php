...
//$cabeceras .= '<jairman301@hotmail.com>'."\r\n";
...
// Enviarlo
	//mail($correo_url, $título, $mensaje, $cabeceras);
	//mail('jairman301@hotmail.com', $título, $mensaje, $cabeceras);
	mail($correo_url, $título, $mensaje, $cabeceras);
...
/*$to      = 'jairman301@hotmail.com';
$subject ='sum';
$message = 'hello';
/*$headers = 'From: jairman301@hotmail.com' . "\r\n" .
    'Reply-To: jairman301@hotmail.com' . "\r\n" .
