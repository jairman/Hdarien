...
<script src="../js/fact_phisto.js" type="text/javascript"></script>
...
<table width="95%" align="center" id="table_header">
  <tr>
    ...
    <div id="menu">
      <ul>
      <li>
      <a href="../../inventario/views/invent_ficha.php?r=<?php echo $ref_url ?>" >Información del Producto</a>
      </li>
      <li>
      <a  href="../../inventario/views/invent_mov.php?r=<?php echo $ref_url ?>" >Historial de Entradas</a>
      </li>
       <li>
      <a  href="fact_phisto.php?r=<?php echo $ref_url ?>" class='active'>Historial de Salidas</a>
      </li>
      </ul>
    </div>  
    </td>
