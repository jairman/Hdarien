...
<table width="90%" align="center" id="tb_prod">
  ...
  <tr id="fila_<?php echo $i?>">
    <td class="cont">
    <!--onFocus="control(< echo $i?>)"-->
    <input name="tf_ref<?php echo $i?>" type="text" id="tf_ref<?php echo $i?>" style="width:70%" class="ref" 
    ...
    <td class="cont">
    <input type="text" id="tf_dcto<?php echo $i?>" class="long" onkeyup="checkNum(this),getdcto(<?php echo $i?>),compare('<?php echo $i?>')" >
    </td>
...
<table width="90%" align="center" id="tb_cost">
  ...
  <tr  align="center">
    ...
    <td class="cont"><input type="text" id="tf_dctofact" class="long" onkeyup="checkNum(this)" onChange="dctofact()"></td>
  </tr>
</table>
