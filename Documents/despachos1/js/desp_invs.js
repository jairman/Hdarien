...
function load1(){
	...
	$('#d_table').load('desp_invs.php?id=' + id.replace(/ /g,"+") + '&i=' + i.replace(/ /g,"+") + '&p=' + p.replace(/ /g,"+") + '&o=' + o.replace(/ /g,"+") + ' #d_table ' );	
}
...
function load2(order){
	...
	var id = $('#tf_idr').val();
	//console.log('id:'+id+' i:'+i)
	$('#d_table').load('desp_invs.php?id=' + id.replace(/ /g,"+") + '&i=' + i.replace(/ /g,"+") + '&p=' + p.replace(/ /g,"+") + '&o=' + order.replace(/ /g,"+") + ' #d_table ' );	
}
