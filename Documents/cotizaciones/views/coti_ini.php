...
<script src="../js/coti_ini.js" type="text/javascript"></script>
...
<table width="95%" border="1" cellspacing="0" align="center">
    ...
    <div id="menu">
      <ul>
      <li>
      <a href="coti_ini.php" class='active'>Cotizaciones</a>
      </li>
      <li>
      <a  href="../../pedidos/views/ped_ini.php">Pedidos</a>
      </li>
      <li>
...
<table width="95%" border="1" align="center" cellspacing="0" id="tb_data">
  ...
  <?php
	...
	<td align="center" 
	onClick="mostrar('../views/coti_fact.php?c=<?php echo $row_muerte['consec'] ?>')">
