...
function getinfo(prove){
	...
	$.ajax({
		type: "GET",
		dataType: 'json',
		url:"../controllers/coti_connect.php",
		data:"getprove="+prove,				
...
function createfact(){
	...
	//console.log("consec="+consec+"&fecha="+fecha+"&fvig="+fvig+"&orig="+orig+"&user="+user2+"&prove="+prove+"&tel="+tel+"&ced="+ced+"&obs="+obs+"&costo="+costo+"&cant="+cant+"&action=new_fact")
	
	$.ajax({
		type:"post",
		url:"../controllers/coti_connect.php",
		data:"consec="+consec+"&fecha="+fecha+"&fvig="+fvig+"&orig="+orig+"&user="+user2+"&prove="+prove+"&tel="+tel+"&ced="+ced+"&obs="+obs+"&costo="+costo+"&cant="+cant+"&action=new_fact",				
		success:function(data){
			//console.log('f: '+data);
		}
	}).done(ffact = true);
...
function cuadro(){
	...
	overlay.show()
	$("#dialog").html('&nbsp;Registrar la Cotización No: '+consec+"?<br>").css('text-align','center');
