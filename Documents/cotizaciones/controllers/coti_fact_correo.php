...
<table width='98%' align='center' id='table_header'>
    ...
    <td align='right' width='5%' rowspan='3'>&nbsp;</td>
    <td align='right' width='5%' rowspan='3'>&nbsp;</td>
    </tr>
    <tr>
      <td align='center'>
    ...
    <tr>
      <td colspan='4'  align='center' bgcolor='$color'  style='color: #FFF'>Registro de Cotización</td>
    </tr>
</table>

<table width='98%'  cellspacing='0' align='center'>
    <tr>
      <td  width='20%' bgcolor='#F0F0F0'>Punto de Venta</td>
      <td width='30%' align='center' ><label>$row_fact[punto_venta]</label></td>
      <td  width='20%' bgcolor='#F0F0F0'>Fecha Cotización</td>
    ...
    <tr>
      ...
      <td  bgcolor='#F0F0F0'>Fecha Vigencia</td>
      <td align='center' ><label>$row_fact[f_vig]</label></td>
    </tr>
    <tr>
      <td  bgcolor='#F0F0F0'>Observaciones</td>
      <td align='center'  colspan='3'><label>$row_fact[obs]</label></td>
    </tr>
  </table>
...
$mensaje.= " 
  <tr id='fila_$i' >
    <td align='center'><label>$row_prod[ref]</label></td>
    <td align='center'><label>$row_prod[desc]</label></td>
    <td align='center'><label>$row_prod[marca]</label></td>
    <td align='center'><label>$row_prod[cant]</label></td>
    <td  align='center'><label>$costo</label></td>
    <td  align='center'>&nbsp;</td>
  </tr>";
...
$mensaje.= " 
  <tr id='fila_$i' >
    ...
    <td align='center'><label>$row_prod[marca]</label></td>
    <td align='center'><label>$row_prod[cant]</label></td>
    <td align='center'><label>$costo2</label></td>
  ...
  $cant1=number_format($row_fact['cant'],2);
  $cost1=number_format($row_fact['costo'],2);
$mensaje.= " 
  
</table>
<table width='98%'  cellspacing='0' align='center'>
  <tr>
  	<td width='20%' bgcolor='#F0F0F0'>Total Items</td>
    <td width='30%' ><label id='lb_toti' class='red'>$cant1</label></td>
    <td width='20%' bgcolor='#F0F0F0'>Total</td>
    <td width='30%' ><label id='lb_totc' class='red'>$cost1</label></td>
  </tr>
  <tr>
...
$cabeceras .= 'From: COTIZACIÓN<'.$remitente.'>' . "\r\n";
