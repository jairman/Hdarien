...
<table width="98%" border="0" align="center" cellspacing="0">
  <tr >
    <td align="left" bgcolor="#FFFFFF"><div id="menu">
      <ul >
        <ul>
          <li> <a href="loco7.php" class='active' >Historial Colectivo</a></li>
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			for ($i=1;$i<=$diasdespues;$i++)
			{
				...
				if ($i>=$primeromes && $i<=$tope) 
				{
					...
					echo "'><a rel='shadowbox[ejemplos];options={continuous:true}' href='loco2.php?fecha=$compuesta' title='Mirar  ".fecha($compuesta)."'class='vtip'>$j<form id='evento$j' method='post' action='".$_SERVER["PHP_SELF"]."' style='display:none'></form>";
					
					else echo "'><a rel='shadowbox[ejemplos];options={continuous:true}' href='loco2.php?fecha=$compuesta' title='Mirar  ".fecha($compuesta)."'class='vtip'>$j<form id='evento$j' method='post' action='".$_SERVER["PHP_SELF"]."' style='display:none'></form>";
