...
<table width="98%" border="0" align="center" cellspacing="0" id="table_header">
  <tr bgcolor="#f0f0f0">
    <td width="858" align="left" bgcolor="#FFFFFF"><div id="menu">
      <ul >
        <ul>
          <li> <a href="loco1.php" class='active'>Historial Colectivo</a> </li>
...
<table width="98%" border="0" align="center">
  <tr>
    <td width="50%" rowspan="2"><img src="img/logo3.png" width="268" height="106" /></td>
...
<table width="98%" border="0" align="center">
  <tr align="center" class="tittle">
    <td width="5%"  style="font-size: 13px">Cedula</td>
    <td width="22%"  style="font-size: 13px">Nombre</td>
    <td width="7%"  style="font-size: 13px">Hora Inicio</td>
    <td width="5%"  style="font-size: 13px">Hora Final</td>
    <td width="7%"  style="font-size: 13px"><p>Almuerzo</p></td>
    <td width="8%"  style="font-size: 13px">Horas Normales</td>
    <td width="6%"  style="font-size: 13px">Horas Extra</td>
    <td width="7%"  style="font-size: 13px">Horas Totales</td>
    <td width="7%"  style="font-size: 13px">Horas Permiso    </td>
    <td width="10%"  style="font-size: 13px">Horas Incapacidad</td>
    <td width="16%"  style="font-size: 13px"><p>Comentario</p></td>
  </tr>
  <?php do { ?>
    <tr class="row">
      <td align="right"  style="font-size: 11px"><?php echo $row_asis['cedula']; ?></td>
	  ...
	  ?></td>
      <td align="right"  style="font-size: 11px"><?php echo $row_asis['inicio']; ?></td>
      <td align="right"  style="font-size: 11px"><?php echo $row_asis['final']; ?></td>
      <td align="right"  style="font-size: 11px"><?php echo $row_asis['entalmuer']?></td>
    ...
    <tr class="row">
      <td colspan="4" align="right" class=" bold"><strong>TOTALES  DIARIAS:</strong></td>
      <td align="right" >&nbsp;</td>
      <td align="center" >
        <?
	   $resultc = mysql_query("SELECT SUM(`hnormales`) as hnormales,SUM(`hextras`) as hextras,SUM(`htotales`) as htotales FROM nomina_ingreso WHERE fecha ='$hoy' "); 
