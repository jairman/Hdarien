...
$query_in = "SELECT * FROM d89xz_detalle_nomina WHERE `cedula`='$cedula' and YEAR(fecha) = '$anoss' AND MONTH(fecha) = '$mes'";
...
<body>
  ...
  <table width="99%" border="0" align="center">
    ...
    <td width="121" align="left">&nbsp;</td>
    <td width="308" align="center"><a href="nomina_este_si.php?cedula=<?php echo $cedula; ?>&amp;hierro=<?php echo $hierro; ?>&amp;cmpes=<?php echo $cmpes; ?>&amp;respes=<?php echo $respon; ?>"><img src="last.png" alt="" width="29" height="31" border="0" /></a></td>
...
<DIV ID="seleccion">
  ...
  <table width="99%" border="0" align="center">
    ...
    <tr bgcolor="#f0f0f0" style="color: #000">
      <th colspan="4" bgcolor="#f0f0f0">Registro De Pagos</th>
    </tr>
    <tr bgcolor="#FFFFFF" style="color: #000">
  ...
  <table width="99%" border="1" align="center" cellspacing="0">
    ...
    <?php do { ?>
      <tr align="center">
        <td><?php echo $row_in['concep']; ?></td>
        <td><?php echo $row_in['tipo']; ?></td>
        <td><?php echo number_format($row_in['valor']); ?></td>
        <td><?php echo $row_in['respon']; ?></td>
        <td><?php echo $row_in['fecha']; ?></td>
      </tr>
