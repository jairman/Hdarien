...
<ul id="MenuBar1" class="MenuBarHorizontal">
  <li><a href="kardex_busqueda.php?vacuno=<?php echo $vacuno ?>&amp;id_vacuno=<?php echo $vacuno ?>&amp;sexo=<?php echo $sexo?>">Editar Control  Reproductivo</a>  </li>
  <li><a href="editar_vacuno.php?vacuno=<?php echo $vacuno ?>&amp;id_vacuno=<?php echo $vacuno ?>&amp;sexo=<?php echo $sexo?>" class="current">Editar</a></li>
  <li onclick="return confirm('Realmente Desea Eliminar Vacuno');"><a href="eliminar_vacuno.php?vacuno=<?php echo $vacuno ?>&amp;sexo=<?php echo $sexo?>">Eliminar</a>  </li>
