...
mysql_select_db($database_conexion, $conexion);
$query_hm = "SELECT id_vacuno, raza, madre,padre, hierro, clase, ubicasion, reprd, tp_rep, estrepr FROM d89xz_vacunos WHERE sexo = 'hembra' and clase='puro' ORDER BY id_vacuno ASC";
...
<ul id="MenuBar1" class="MenuBarHorizontal">
 ...
 <p>&nbsp;</p>
<ul id="MenuBar1" class="MenuBarHorizontal">
<li><a href="busqueda_reproductoras.php"  class="current">Puras</a>  </li>
    <li><a href="busqueda_reproductoras_comer.php">Comerciales</a></li>
    <li><a href="busqueda_reproductoras_VCN.php">VOE</a></li>
</ul>
<p>&nbsp;</p>
...
<DIV ID="seleccion1">
  ...
  <tr class="s" style="color: #FFF">
    <th colspan="7" bgcolor="#4D68A2">Inventario Hembras Puras</th>
    </tr>
  ...
  <?php do {?>
   <tr id="fila_<?php echo $row_hm['id_vacuno']; ?>" onMouseOver="ResaltarFila('fila_<? echo $row_hm['id_vacuno']; ?>');mano(this);" onMouseOut="RestablecerFila('fila_<? echo $row_hm['id_vacuno']; ?>')" onClick="CrearEnlace('kardex_busqueda.php?id_vacuno=<?php echo $row_hm['id_vacuno']; ?>&amp;vacuno=<?php echo $row_hm['id_vacuno']; ?>&amp;sexo=<?php echo $row_hm['sexo']; ?>');">
      ...
      <td align="center"><?php echo $row_hm['tp_rep']; ?></td>
