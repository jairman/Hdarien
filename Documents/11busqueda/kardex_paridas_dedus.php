...
<li><a href="kardex_paridas.php" >Lechería</a></li>
  <li><a href="kardex_paridas_dedus.php" class="current">Deducciones</a>  </li>
...
<form id="form1" name="form1" method="post" action="">
  <table width="398" border="1" align="center" cellspacing="0">
    <tr>
      <th colspan="2" bgcolor="#4D68A2">Ingreso Deducciones de  Leche Semanal</th>
    </tr>
    <tr>
      <th colspan="2" bgcolor="#f0f0f0">&nbsp;</th>
    </tr>
    <tr>
      <th width="177" bgcolor="#4D68A2">ID</th>
      <th width="211" bgcolor="#4D68A2"><? echo $action?></th>
    </tr>
    <tr>
...
$insertar = mysql_query("INSERT INTO d89xz_detalle_leche (dedu,semana,klos,fecha,sen_ano,fact)
					VALUES ('si','{$semana}', '{$klos}', '{$fecha}', '{$numeroSemana}','5')", $conexion);
