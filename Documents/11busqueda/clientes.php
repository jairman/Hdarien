...
@$cedula=$_POST['cedula'];
$queEmp ="SELECT * FROM `d89xz_clientes` WHERE `cedula`= '$cedula'";
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO d89xz_clientes (cedula, nombre, apellido, telefono, empresa, categ, dir, ciud, fax, mail,cel,comen) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
	  ...
	  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());
		...
		echo "<script type=''>
			...
			echo "<script type=''>
		window.location='clientes_kardex.php';
	</script>";
...
mysql_select_db($database_conexion, $conexion);
$query_cl = "SELECT * FROM d89xz_clientes";
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table width="600" border="1" align="center" >
    <tr align="center" valign="baseline" bgcolor="#4D68A2" style="color: #FFF">
      <th colspan="2" bgcolor="#4D68A2"><p>Formulario de Ingreso</p></th>
    </tr>
    ...
    <tr valign="baseline" bgcolor="#FFFFFF">
      <th align="left" nowrap="nowrap" style="color: #000">Web </th>
      <td align="center"><input type="text" name="apellido" value="" size="60" /></td>
    </tr>
    <tr valign="baseline" bgcolor="#FFFFFF">
      <th align="left" nowrap="nowrap" style="color: #000">Contacto </th>
      <td align="center"><input type="text" name="empresa" value="" size="60" /></td>
    </tr>
    <tr valign="baseline" bgcolor="#FFFFFF">
      <th align="left" nowrap="nowrap" style="color: #000"><p>Celular</p></th>
      <td align="center"><input name="celular" type="text" id="celular" value="" size="60" /></td>
    </tr>
    <tr valign="baseline" bgcolor="#FFFFFF">
    ...
    <tr valign="baseline" bgcolor="#FFFFFF">
      <th align="left" nowrap="nowrap" style="color: #000">Categor&iacutea </th>
      <td align="center"><span id="spryselect1">
      <select name="categ" id="categ" style="width:390">
        <option value="">Seleccione  Categor&iacutea  Del   Cliente</option>
        <?php
do {  
?>
...
?>
    ...
    <tr valign="baseline" bgcolor="#FFFFFF">
      <th align="left" nowrap="nowrap" style="color: #000"><p>Observaciones</p></th>
      <td align="center"><input name="comen" type="text" id="comen" value="" size="60" /></td>
    </tr>
    <tr valign="baseline" bgcolor="#4D68A2" style="color: #FFF">
      <td colspan="2" align="center" nowrap="nowrap" bgcolor="#FFFFFF"><input type="image" src="aceptar.png"  onmouseover="src='aceptar1.png';"  onmouseout="src='aceptar.png';" value="Insertar Clientes" alt="aceptar" />
        <a  href="clientes_kardex.php" onClick="javascript:window.parent.Shadowbox.close();"><img src="cancelar.png" width="68" height="20"></a>  </a></td>
    </tr>
  </table>
