...
@$vacuno1 =$_GET['vacuno1'];
@$vacuno2 =$_GET['vacuno2'];
@$vacuno3 =$_GET['vacuno3'];
@$vacuno4 =$_GET['vacuno4'];
@$vacuno5 =$_GET['vacuno5'];
@$vacuno6 =$_GET['vacuno6'];
@$vacuno7 =$_GET['vacuno7'];
@$vacuno8 =$_GET['vacuno8'];
@$vacuno9 =$_GET['vacuno9'];
@$vacuno10 =$_GET['vacuno10'];
  ...
  <table width="586" border="1" align="center" cellspacing="0">
    ...
    <tr>
      ...
      <!--  <option value="<? echo $estado?>">Seleccione</option>-->
        ...
        <option value="palpacion2VCN.php?pal=VCN">VCN</option>
...
?>
    ...
    <tr>
      ...
      <input name="V_1" type="text" id="V_1" value="<?php echo $vacuno1 ?>" /></td>
      <td>Comentario</td>
