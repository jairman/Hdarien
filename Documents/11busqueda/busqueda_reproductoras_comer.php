...
mysql_select_db($database_conexion, $conexion);
$query_hm = "SELECT id_vacuno, raza, madre,padre, hierro, clase, ubicasion, reprd, tp_rep, estrepr FROM d89xz_vacunos WHERE sexo = 'hembra' and clase='comercial' ORDER BY id_vacuno ASC";
...
<li><a href="busqueda_reproductoras.php"  >Puras</a>  </li>
    <li><a href="busqueda_reproductoras_comer.php" class="current">Comerciales</a></li>
...
<table width="100%" border="1" cellspacing="0">
  ...
  <tr class="s" style="color: #FFF">
    <th colspan="7" bgcolor="#4D68A2">Inventario Hembras Comerciales</th>
    </tr>
  <tr class="s" style="color: #FFF">
