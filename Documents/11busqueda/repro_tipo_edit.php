...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $Result1 = mysql_query($updateSQL, $conexion) or die(mysql_error());
    $updateGoTo = "busqueda_reproductoras.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_conexion, $conexion);
$query_tp = "SELECT tp_rep1 FROM d89xz_tipo_reproductoras";
$tp = mysql_query($query_tp, $conexion) or die(mysql_error());
$row_tp = mysql_fetch_assoc($tp);
$totalRows_tp = mysql_num_rows($tp);mysql_select_db($database_conexion, $conexion);
$query_tp = "SELECT tp_rep1 FROM d89xz_tipo_reproductoras";
$tp = mysql_query($query_tp, $conexion) or die(mysql_error());
$row_tp = mysql_fetch_assoc($tp);
...
<table width="100%" border="0" align="center" cellspacing="0">
  <tr>
    <td align="center" bgcolor="#f0f0f0"><a href="busqueda_reproductoras.php"><img src="last.png" alt="" width="29" height="31" border="0" /></a></td>
  </tr>
</table>
<p>&nbsp;</p>
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  ...
  <table width="396" border="1" align="center" cellspacing="0">
    <tr valign="baseline">
      <th width="183" align="left" nowrap="nowrap" bgcolor="#4D68A2" style="color: #FFF">ID Vacuno:</th>
      <td width="197" align="center" bgcolor="#4D68A2"><?php echo $row_es['id_vacuno']; ?></td>
    </tr>
    <tr valign="baseline">
...
do {  
?>
          <option value="<?php echo $row_tp['tp_rep1']?>"><?php echo $row_tp['tp_rep1']?></option>
          <?php
