...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO d89xz_tipo_reproductoras (tp_rep1) VALUES (%s)",
...
mysql_select_db($database_conexion, $conexion);
$query_kard = "SELECT * FROM d89xz_tipo_reproductoras";
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table width="395" border="1" align="center">
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tipos  De  Reproductoras:</td>
...
<table width="395" border="1" align="center">
  <tr class="c">
    <th width="234" bgcolor="#4D68A2">Tipos  De  Reproductoras</th>
    <th width="62" bgcolor="#4D68A2">Eliminar</th>
  </tr>
  <?php do { ?>
    <tr>
      <th><?php echo $row_kard['tp_rep1']; ?></th>
      <td align="center"><a href="eliminar_ingre_tipo_reproduc.php?id=<?php echo $row_kard['id']; ?>">Eliminar</a></td>
    </tr>
