...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $Result1 = mysql_query($updateSQL, $conexion) or die(mysql_error());
  	$updateGoTo = "kardex_busquedaM.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<ul id="MenuBar1" class="MenuBarHorizontal">
  <li><a href="kardex_busquedaM.php?vacuno=<?php echo $vacuno ?>&amp;id_vacuno=<?php echo $vacuno ?>">Informacion</a>  </li>
  <li><a href="editar_vacunoM.php?vacuno=<?php echo $vacuno ?>&amp;id_vacuno=<?php echo $vacuno ?>" class="current">Editar</a></li>
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table width="99%" border="0" align="center">
    <tr>
      ...
      <td width="308" align="center"><a href="kardex_busquedaM.php?vacuno=<?php echo $vacuno ?>&amp;id_vacuno=<?php echo $vacuno ?>"><img src="last.png" alt="" width="29" height="31" border="0" /></a></td>
  ...
  <table border="1" align="center">
    <tr valign="baseline">
      ...
      <th width="69" align="center" bgcolor="#4D68A2">Cambio</th>
    </tr>
    <tr valign="baseline">
      <th align="left" nowrap="nowrap" bgcolor="#4D68A2">ID</th>
      <td><input type="text" name="id_vacuno" value="<?php echo htmlentities($row_mdff['id_vacuno'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
      <td>&nbsp;</td>
    </tr>
    <tr valign="baseline">
      <th align="left" nowrap="nowrap" bgcolor="#4D68A2">Raza:</th>
...
?>
    ...
    <tr valign="baseline">
      <th align="left" nowrap="nowrap" bgcolor="#4D68A2">Color:</th>
...
?>
    ...
    <tr valign="baseline">
      ...
      <td><label for="clasificasion"></label>
        <select name="clasificasion" id="clasificasion">
          <?php
do {  
?>
...
?>
    ...
    <tr valign="baseline">
      <th align="left" nowrap="nowrap" bgcolor="#4D68A2">Hierro:</th>
...
?>
    ...
    <tr valign="baseline">
      <th align="left" nowrap="nowrap" bgcolor="#4D68A2">Clase:</th>
    ...
    <tr valign="baseline">
      <th align="left" nowrap="nowrap" bgcolor="#4D68A2">Ubicacion:</th>
      ...
      <td><label for="ubicasion"></label>
        <select name="ubicasion" id="ubicasion">
          <?php
do {  
?>
...
?>
    ...
    <tr valign="baseline">
      <th align="left" nowrap="nowrap" bgcolor="#4D68A2">Registro:</th>
