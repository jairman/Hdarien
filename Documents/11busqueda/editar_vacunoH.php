...
<ul id="MenuBar1" class="MenuBarHorizontal">
  <li><a href="krdex_reprod.php.php?vacuno=<?php echo $vacuno ?>&amp;id_vacuno=<?php echo $vacuno ?>">Informacion</a>  </li>
  <li><a href="editar_vacunoH.php?vacuno=<?php echo $vacuno ?>&amp;id_vacuno=<?php echo $vacuno ?>" class="current">Editar</a></li>
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table width="99%" border="0" align="center">
    <tr>
      ...
      <td width="308" align="center"><a href="krdex_reprod.php?vacuno=<?php echo $vacuno ?>&amp;id_vacuno=<?php echo $vacuno ?>"><img src="last.png" alt="" width="29" height="31" border="0" /></a></td>
