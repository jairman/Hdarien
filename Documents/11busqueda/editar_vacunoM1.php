...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table border="1" align="center" cellspacing="0">
    <tr valign="baseline">
      ...
      <th width="192" align="center" nowrap="nowrap" bgcolor="#4D68A2" class="a">Actual11</th>
...
do {  
?>
          <option value="<?php echo $row_clasificacion['clasificacison']?>" selected="selected"<?php if (!(strcmp($row_clasificacion['clasificacison'], $row_mdff['clasificasion']))) {echo "selected=\"selected\"";} ?>><?php echo $row_clasificacion['clasificacison']?></option>
          <?php
