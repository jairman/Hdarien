...
$query_cr = " select * FROM d89xz_vacunos WHERE `tp_rep` ='CRIA HEMBRA' and  YEAR(f_ingreso) = '$anoss' AND MONTH(f_ingreso) = '$mes' ORDER BY edad DESC ";
...
<ul id="MenuBar1" class="MenuBarHorizontal">
    ...
    <li><a href="paritorio_vacas_nacimientos_machos.php?mes=<? echo $mes ?>" >Crías Machos</a></li>
  <li><a href="paritorio_vacas_nacimientos_hembras.php?mes=<? echo $mes ?>" class="current">Crías Hembras</a></li>
...
<DIV ID="seleccion">
  ...
  <table width="100%" border="1" align="center" cellspacing="0">
    ...
    <tr bgcolor="#4D68A2" style="color: #FFF">
      <th colspan="5">Nacimientos Crías Hembas</th>
      <th><? echo $prueba1?></th>
    </tr>
    <tr bgcolor="#4D68A2" style="color: #FFF">
