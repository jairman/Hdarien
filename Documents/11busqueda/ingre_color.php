...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO d89xz_color_raza (color) VALUES (%s)",
...
mysql_select_db($database_conexion, $conexion);
$query_razas = "SELECT * FROM d89xz_color_raza";
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table width="426" border="1">
    ...
    <tr>
      <td width="147"><strong>Ingrese Color</strong></td>
...
<table width="426" border="1">
  <tr class="c">
    <th width="287" bgcolor="#4D68A2"><strong>Colores Existentes</strong></th>
    <th width="56" bgcolor="#4D68A2">Eliminar</th>
  </tr>
  <?php do { ?>
    <tr>
      <td align="center"><?php echo $row_razas['color']; ?></td>
      <td align="center"><a href="eliminar_color.php?id=<?php echo $row_razas['id']; ?>">Eliminar</a></td>
    </tr>
