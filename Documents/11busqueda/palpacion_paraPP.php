...
<table width="100%" border="0" align="center" cellspacing="0">
  <tr>
    ...
    <td width="121" align="left" bgcolor="#f0f0f0">&nbsp;</td>
    <td width="308" align="center" bgcolor="#f0f0f0"><a href="palpacion_pp.php"><img src="last.png" alt="" width="29" height="31" border="0" /></a></td>
...
$insertar = mysql_query("INSERT INTO d89xz_detalle_palpacion(vaca,f_palpa,estado)
		...
		window.location='palpacion_pp.php?id_vacuno=" . $id_vacuno. "&vacuno=" .$vacuno. "&padre=" .$padre. "&madre=" .$madre. "';
