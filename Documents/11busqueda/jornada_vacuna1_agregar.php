...
<form id="form1" name="form1" method="post" action="">
  <table width="470" border="1" align="center" cellspacing="0">
    <tr>
      <th colspan="4" bgcolor="#4D68A2" style="color: #FFF">Asignar Jornada de Vacunación</th>
    </tr>
    <tr>
      <td width="164" id="ss">Fecha</td>
...
$insertar1 = mysql_query("UPDATE `d89xz_vacunos` SET `vacuna`='$text_f_tarea', `resvac`= '$responsable', `cmvac`='$textarea_tarea' WHERE `hierro`='$hierro' and ubicasion='$ubica' and   YEAR(f_ingreso) = '$ano' AND MONTH(f_ingreso) = '$mes'  ", $conexion);
