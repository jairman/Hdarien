...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE d89xz_total_medicinas SET nombre=%s, descrip=%s, coment=%s, cont=%s, mark=%s, m_uso=%s, p_act=%s, admin=%s WHERE id=%s",
 ...
 $insertar2= mysql_query("UPDATE  `d89xz_provincia` SET `det_pro`= '$nombre1', descrip='$descrip1', coment='$coment1', cont='$cont1', mark='$mark1' Where det_pro='$nombre' and tipo='$tipo' and descrip='$descrip' and coment='$coment' and cont='$cont' and mark='$mark'  ", $conexion);
  

  $updateGoTo = "kardex_medicina.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_conexion, $conexion);
$query_mdc = sprintf("SELECT * FROM d89xz_total_medicinas WHERE id = %s", GetSQLValueString($colname_mdc, "int"));
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table width="376" border="1" align="center" cellspacing="0">
    <tr valign="baseline">
      <th align="center" nowrap="nowrap" bgcolor="#4D68A2">ID</th>
      <td align="center" bgcolor="#4D68A2"><?php echo $row_mdc['id']; ?></td>
    </tr>
    <tr valign="baseline">
      <td align="left" nowrap="nowrap" bgcolor="#FFFFFF" style="font-weight: bold">Tipo:</td>
      <td align="center" bgcolor="#FFFFFF"><?php echo $row_mdc['tipo']; ?></td>
     <!-- <td><input type="text" name="tipo" value="<?php // echo htmlentities($row_mdc['tipo'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>-->
    </tr>
    <tr valign="baseline">
      <td align="left" nowrap="nowrap" bgcolor="#FFFFFF" style="font-weight: bold">Nombre:</td>
      <th><input type="text" name="nombre" value="<?php echo htmlentities($row_mdc['nombre'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></th>
    </tr>
    <tr valign="baseline">
      <td align="left" nowrap="nowrap" bgcolor="#FFFFFF" style="font-weight: bold">Descripción:</td>
      <th><input type="text" name="descrip" value="<?php echo htmlentities($row_mdc['descrip'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></th>
    </tr>
    <tr valign="baseline">
      <td align="left" nowrap="nowrap" bgcolor="#FFFFFF" style="font-weight: bold">Contenido:</td>
    ...
    <tr valign="baseline">
      <td align="left" nowrap="nowrap" bgcolor="#FFFFFF" style="font-weight: bold">Marca:</td>
      <th><input type="text" name="mark" value="<?php echo htmlentities($row_mdc['mark'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></th>
    </tr>
    <tr valign="baseline">
      <td align="left" nowrap="nowrap" bgcolor="#FFFFFF" style="font-weight: bold">Presentación:</td>
      <th><input type="text" name="m_uso" value="<?php echo htmlentities($row_mdc['m_uso'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></th>
    </tr>
    <tr valign="baseline">
      <td align="left" nowrap="nowrap" bgcolor="#FFFFFF" style="font-weight: bold"> P. Activo </td>
      <th><input name="activo" type="text" id="activo" value="<?php echo $row_mdc['p_act']; ?>" size="32" /></th>
    </tr>
    <tr valign="baseline">
      <td align="left" nowrap="nowrap" bgcolor="#FFFFFF" style="font-weight: bold"> Vía Admin </td>
      <th><input name="admin" type="text" id="admin" value="<?php echo $row_mdc['admin']; ?>" size="32" /></th>
      
      
    </tr>
    <tr valign="baseline">
      <td align="left" nowrap="nowrap" bgcolor="#FFFFFF" style="font-weight: bold"> Dosificación </td>
