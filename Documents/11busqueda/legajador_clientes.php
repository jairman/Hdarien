...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE d89xz_clientes SET cedula=%s, nombre=%s, apellido=%s, telefono=%s, empresa=%s, categ=%s, dir=%s, ciud=%s, fax=%s, mail=%s, cel=%s , comen=%s WHERE id=%s",
...
mysql_select_db($database_conexion, $conexion);
$query_ss = sprintf("SELECT * FROM d89xz_clientes WHERE cedula = %s", GetSQLValueString($colname_ss, "text"));
$ss = mysql_query($query_ss, $conexion) or die(mysql_error());
$row_ss = mysql_fetch_assoc($ss);
$totalRows_ss = mysql_num_rows($ss);

mysql_select_db($database_conexion, $conexion);
$query_ctg = "SELECT * FROM d89xz_catego";
...
@$prove=$_GET['prove'];
mysql_select_db($database_conexion, $conexion);
$query_fac = "SELECT * FROM d89xz_diario WHERE `cel_client`='$prove'";
...
mysql_select_db($database_conexion, $conexion);
$query_inb = sprintf("SELECT * FROM d89xz_clientes WHERE cedula = %s", GetSQLValueString($colname_inb, "text"));
...
<li type="square" class="TabbedPanelsTab" tabindex="">Editar Clientes</li>
<p><!--  le quite el recuadrito maluquito  tabindex="0"  -->
</p>
<table width="99%" border="0" align="center">
  <tr>
    <td width="121" align="left">&nbsp;</td>
    <td width="121" align="left">&nbsp;</td>
    <td width="308" align="center"><a href="clientes_kardex.php?cedula=<?php echo $cedula; ?>&amp;hierro=<?php echo $hierro; ?>&amp;cmpes=<?php echo $cmpes; ?>&amp;respes=<?php echo $respon; ?>"><img src="last.png" alt="" width="29" height="31" border="0" /></a></td>
    ...
    <div class="TabbedPanelsContent">
      <DIV ID="seleccion">
        ...
        <table width="800" align="center">
          <tr>
            <th colspan="4" bgcolor="#4D68A2"><p>Información Básica Del Cliente</p></th>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
    ...
    <div class="TabbedPanelsContent">
      <table width="100%" border="1" align="center" cellspacing="0">
        <tr bgcolor="#4D68A2" style="color: #FFF">
          <th width="148">Fecha</th>
          <th width="361" bgcolor="#4D68A2">Descripción</th>
          <th width="123" bgcolor="#4D68A2">N° Factura P.</th>
          <th width="135" bgcolor="#4D68A2">Fecha De Pago</th>
          <th width="189">Condicion De Pago</th>
          <th width="107">Valor</th>
        </tr>
        <?php do { ?>
        <tr align="center" bgcolor="#F0F0F0">
          ...
          <td><?php echo number_format ($row_fac['v_tal']); ?></td>
        </tr>
...
<div class="TabbedPanelsContent">
      <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
        <table width="600" border="1" align="center" cellspacing="0">
          ...
          <tr valign="baseline" bgcolor="#FFFFFF" style="color: #000">
          ...
          <tr valign="baseline" bgcolor="#FFFFFF" style="color: #000">
            <th align="left" nowrap>Categor&iacutea</th>
...
?>
          ...
          <tr valign="baseline" bgcolor="#FFFFFF" style="color: #000">
            <th align="left" nowrap>Observaciones</th>
