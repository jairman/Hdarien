...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE d89xz_vacunos SET tp_rep=%s, id_vacuno=%s, raza=%s, color=%s, padre=%s, madre=%s, clasificasion=%s, calificasion=%s, sexo=%s,  hierro=%s, clase=%s,f_ingreso=%s,e_ingreso=%s, ubicasion=%s, registro=%s, cos_entro=%s  WHERE id=%s",
					   ...
					   GetSQLValueString($_POST['fecha_ingre'], "text"),
					   GetSQLValueString($_POST['e_ingreso'], "text"),
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table width="100%" border="0" align="center" cellspacing="0">
    <tr>
      <th align="center" bgcolor="#f0f0f0"><a href="kardex_busqueda.php?vacuno=<?php echo $vacuno ?>&amp;id_vacuno=<?php echo $vacuno ?>&amp;sexo=<?php echo $sexo?>"><img src="last.png" alt="" width="29" height="31" border="0" /></a></th>
    </tr>
  </table>
  <table border="1" align="center" cellspacing="0">
    <tr valign="baseline">
      ...
      <th width="170" align="center" bgcolor="#4D68A2">Cambiar Por </th>
    </tr>
    <tr valign="baseline" bgcolor="#f0f0f0">
      <th align="center" nowrap="nowrap" style="color: #000">Estado Fisiológico</th>
      <td><input name="tp_rep1" type="text" id="tp_rep1" value="<?php echo htmlentities($row_mdff['tp_rep'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
      <td><select name="tp_rep" id="tp_rep" style="width:200px">
        <?php
do {  
?>
        <option value="<?php echo $row_clasificacion['clasificacison']?>"<?php if (!(strcmp($row_clasificacion['clasificacison'], $row_mdff['tp_rep']))) {echo "selected=\"selected\"";} ?>><?php echo $row_clasificacion['clasificacison']?></option>
        <?php
...
?>
    ...
    <tr valign="baseline" bgcolor="#FFFFFF">
      <th align="left" nowrap="nowrap" style="color: #000">Clasificación Entrada</th>
...
?>
    ...
    <tr valign="baseline" bgcolor="#FFFFFF">
      <th align="left" nowrap="nowrap" style="color: #000">Fecha De Ingreso</th>
      <td><input name="fecha_ingre" type="text" id="fecha_ingre" value="<?php echo htmlentities($row_mdff['f_ingreso']); ?>" size="32" /></td>
      <td>&nbsp;</td>
    </tr>
    <tr valign="baseline" bgcolor="#FFFFFF">
      <th align="left" nowrap="nowrap" style="color: #000">Edad Ingreso</th>
      <td><input name="edad" type="text" id="edad" value="<?php echo htmlentities($row_mdff['e_ingreso']); ?>" size="32" /></td>
      <td>&nbsp;</td>
    </tr>
    <tr valign="baseline" bgcolor="#FFFFFF">
      <th align="left" nowrap="nowrap" style="color: #000">Costo Ingreso ($)</th>
      <td><input name="costo" type="text" id="costo" value="<?php echo htmlentities( $row_mdff['cos_entro']);  ?>" size="32" /></td>
      <td>&nbsp;</td>
    </tr>
    <tr valign="baseline" bgcolor="#FFFFFF">
