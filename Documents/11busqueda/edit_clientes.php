...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE d89xz_clientes SET nombre=%s, apellido=%s, telefono=%s, empresa=%s , descr=%s WHERE cedula=%s",
...
mysql_select_db($database_conexion, $conexion);
$cedula=$_GET['cedula'];
$query_clieent = "SELECT * FROM d89xz_clientes WHERE cedula = '$cedula'";
