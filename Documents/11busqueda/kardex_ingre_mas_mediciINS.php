...
$query_m = "SELECT tipo, nombre, cont,mark, cantid, fecha, concep, comen FROM d89xz_total_medicinas_salidasins WHERE idm ='$id' ORDER BY fecha DESC";
...
<table width="100%" border="0" cellspacing="0">
  <tr>
    ...
    <th width="40%" bgcolor="#f0f0f0"><a href="kardex_medicinaINS.php"><img src="last.png" alt="" width="29" height="31" border="0" /></a></th>
...
<table width="100%" border="1" align="center" cellspacing="0">
  <tr class="x">
    <th colspan="4" align="right" bgcolor="#4D68A2">&nbsp;</th>
  </tr>
  <tr class="x">
    <th colspan="4" align="right" bgcolor="#f0f0f0">&nbsp;</th>
  </tr>
  <tr class="x">
    <th width="86" bgcolor="#4D68A2">Cantidad</th>
    <th width="232" bgcolor="#4D68A2">Fecha</th>
    <th width="116" bgcolor="#4D68A2">Concepto</th>
    <th width="647" bgcolor="#4D68A2">Comentario</th>
  </tr>
  <?php do { ?>
    <tr>
      ...
      <td align="center"><?php echo $row_m['comen']; ?></td>
    </tr>
