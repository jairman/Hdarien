...
$query_km = "SELECT * FROM d89xz_total_medicinasins";
...
<ul id="MenuBar1" class="MenuBarHorizontal" >
  <li><a href="kardex_medicinaINS.php?vacuno=<?php echo $vacuno ?>&amp;id_vacuno=<?php echo $vacuno ?>"class="current"  >Inventario</a>  </li>
</ul>
 <p>&nbsp;</p>
<table width="100%" border="0" align="center" cellspacing="0" >
  <tr bgcolor="#f0f0f0">
    <td width="15%"><a  href="ingre_medicinasINS.php"><img src="add.png" alt="" width="68" height="20" /></a></td>
    <td width="15%">&nbsp;</td>
...
<table width="100%" border="1" cellspacing="0">
  ...
  <tr class="s">
    <th colspan="5" bgcolor="#4D68A2"><span style="color: #FFF">Inventario Insumos</span></th>
  </tr>
  <tr class="s">
  ...
  <tr class="s">
    ...
    <th width="76" bgcolor="#4D68A2">Contenido</th>
    <th width="71" bgcolor="#4D68A2">Cantidad</th>
    </tr>
  <?php do { ?>
     <tr align="center" id="fila_<? echo $row_km['id']; ?>" onMouseOver="ResaltarFila('fila_<? echo $row_km['id']; ?>');mano(this);"  onMouseOut="RestablecerFila('fila_<? echo $row_km['id']; ?>')" onClick="CrearEnlace('ingreso_mas_medicinas_kardexINS.php?tipo=<?php echo $row_km['tipo']; ?>&amp;contenido=<?php echo $row_km['cont']; ?>&amp;nombre=<?php echo $row_km['nombre']; ?>&amp;marca=<?php echo $row_km['mark']; ?>&amp;id=<?php echo $row_km['id']; ?>&amp;descrip=<?php echo $row_km['descrip']; ?>&amp;comen=<?php echo $row_km['coment']; ?>');">
      ...
      <th><?php echo $row_km['cantid'] ?></th>
      </tr>
    <?php } while ($row_km = mysql_fetch_assoc($km)); ?>
</table>
<p><a href="correo.php">correo</a></p>
</DIV>
</body>
</html>
<?php
