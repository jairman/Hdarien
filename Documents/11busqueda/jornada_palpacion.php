...
<p>&nbsp;</p>
<ul id="MenuBar1" class="MenuBarHorizontal">
  <li><a href="jornada_palpacion.php" class="current">Agenda / Grupo</a>  </li>
...
<table width="100%" border="0" align="center">
  ...
  <tr>
    <th colspan="4" align="center" bgcolor="#FFFFFF" style="color: #FFF">&nbsp;</th>
  </tr>
  <tr bgcolor="#f0f0f0">
...
<table width="100%" border="1" align="center" cellspacing="0">
  <tr bgcolor="#4D68A2" style="color: #FFF">
    <th width="14%"><p>Jornada </p></th>
    <th width="10%">Raza</th>
    <th width="9%">Clase</th>
    <th width="9%">Hierro</th>
    <th width="24%"><p>Responsable</p></th>
    <th width="34%">Comentario</th>
  </tr>
  <?php do { ?>
    <tr align="center">
      <td><a href="jornada_palpacion+++.php?jpalpa=<?php echo $row_jor['jpalpa']; ?>&amp;respal=<?php echo $row_jor['respal']; ?>&amp;cmpal=<?php echo $row_jor['cmpal']; ?>&amp;raza1=<?php echo $row_jor['raza']; ?>&amp;color1=<?php echo $row_jor['color']; ?>&amp;clase1=<?php echo $row_jor['clase']; ?>&amp;hierro1=<?php echo $row_jor['hierro']; ?>"><?php echo $row_jor['jpalpa']; ?></a></td>
