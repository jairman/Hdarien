...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table width="100%" border="0" align="center" cellspacing="0">
    <tr>
      <th align="center" bgcolor="#f0f0f0"><a href="krdex_reprod.php?vacuno=<?php echo $vacuno ?>&amp;id_vacuno=<?php echo $vacuno ?>"><img src="last.png" alt="" width="29" height="31" border="0" /></a></th>
    </tr>
  </table>
