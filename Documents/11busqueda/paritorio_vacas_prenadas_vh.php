...
$query_nv = "SELECT * FROM d89xz_vacunos WHERE tp_rep = 'Vaca Prenada'";
$nv = mysql_query($query_nv, $conexion) or die(mysql_error());
$row_nv = mysql_fetch_assoc($nv);
$totalRows_nv = mysql_num_rows($nv);mysql_select_db($database_conexion, $conexion);
$query_nv = "SELECT * FROM d89xz_vacunos WHERE tp_rep = 'Vaca Prenada'";
$nv = mysql_query($query_nv, $conexion) or die(mysql_error());
$row_nv = mysql_fetch_assoc($nv);
...
<ul id="MenuBar1" class="MenuBarHorizontal">
 ...
 <ul id="MenuBar1" class="MenuBarHorizontal">
    ...
    <li><a href="paritorio_vacas_prenadas_nv.php" >Novilla De Vientre</a></li>
  <li><a href="paritorio_vacas_prenadas_vh.php" class="current">Vaca Horras Preñadas</a></li>
...
<DIV ID="seleccion">
  ...
  <table width="100%" border="1" cellspacing="0">
    ...
    <tr>
      <th colspan="5" bgcolor="#4D68A2" style="color: #FFF">Inventario Vacas Horras Preñadas</th>
    </tr>
    <tr>
      <th colspan="5" bgcolor="#f0f0f0" style="color: #FFF">&nbsp;</th>
    </tr>
    <tr>
      <th width="17%" bgcolor="#4D68A2" style="color: #FFF">ID</th>
      ...
      <th width="43%" bgcolor="#4D68A2" style="color: #FFF">Observaciones</th>
    </tr>
    <?php do { ?>
      <tr align="center">
