...
$query_pd = "SELECT * FROM d89xz_vacunos WHERE tp_rep = 'Vaca Parida'";
...
<ul id="MenuBar1" class="MenuBarHorizontal">
  ...
  <li><a href="busqueda_reproductoras.php">Hembras</a></li>
    <li><a href="kardex_paridas_inven.php"  class="current">Paridas</a></li>
...
<table width="100%" border="1" align="center" cellspacing="0">
  ...
  <tr class="a">
    <th colspan="7" bgcolor="#4D68A2">Inventario Hembras Paridas</th>
    </tr>
  <tr class="a">
  ...
  <tr class="a">
    ...
    <th width="266" bgcolor="#4D68A2">Ubicacion</th>
    <th width="82" bgcolor="#4D68A2">Lecheria</th>
  </tr>
  <?php do { ?>
    <tr align="center">
      <td><strong><?php echo $row_pd['id_vacuno']; ?></strong></td>
	  ...
	  if($row_pd['leche']=='si'){
	  	echo " <td bgcolor='#00CC00'>Agregada</td>";
	  }else{
		  	
			
		echo " <td ><a  href='kardex_paridas_inven_agregar.php?id_vacuno=$row_pd[id_vacuno]' >Agregar A</a></td>";
		  }
