...
<form id="form1" name="form1" method="post" action="">
  <table width="456" border="1" align="center" cellspacing="0">
    <tr>
      <th colspan="4" bgcolor="#4D68A2"><p>Asignar Jornada de Peso</p></th>
      </tr>
    <tr>
...
?>
    ...
    <tr>
      <td style="font-weight: bold">Tipo De Pesaje</td>
      <td colspan="3"><span id="spryselect">
...
$insertar = mysql_query("UPDATE `d89xz_vacunos` SET `jpeso`='$text_f_tarea', `respes`= '$responsable', `cmpes`='$textarea_tarea', `tipo_pes`='$tipopes' WHERE `raza`='$raza' and `color`='$color' and `sexo`='$sexo' and `clase`='$clase' and `hierro`='$hierro' and ubicasion='$ubica' ", $conexion);
