...
$query_in = "SELECT * FROM d89xz_ventas WHERE venta!='0' and YEAR(fecha) = '$anoss' AND MONTH(fecha) = '$mes'";
...
<body>
  ...
  <table width="99%" border="0" align="center">
    ...
    <td width="121" align="left">&nbsp;</td>
    <td width="308" align="center"><a href="kar_ventas.php?jpeso=<?php echo $jpeso; ?>&amp;hierro=<?php echo $hierro; ?>&amp;cmpes=<?php echo $cmpes; ?>&amp;respes=<?php echo $respon; ?>"><img src="last.png" alt="" width="29" height="31" border="0" /></a></td>
...
<DIV ID="seleccion">
  ...
  <table width="99%" border="0" align="center">
    ...
    <tr bgcolor="#f0f0f0" style="color: #000">
      <th colspan="4" bgcolor="#f0f0f0">Registro De Venta</th>
    </tr>
    <tr bgcolor="#FFFFFF" style="color: #000">
  ...
  <table width="99%" border="1" align="center" cellspacing="0">
    <tr bgcolor="#4D68A2" style="color: #FFF">
      <th width="24%">ID</th>
      <th width="22%">Peso(Kg)</th>
      <th width="23%">Valor(Kg)</th>
      <th width="23%">Precio Venta</th>
      <th width="8%">Factura</th>
    </tr>
    <?php do { ?>
      <tr align="center">
        <td><?php echo $row_in['vacuno']; ?></td>
        <td><?php echo number_format ($row_in['peso']); ?></td>
        <td><?php echo number_format ($row_in['v_kilo']); ?></td>
        <td><?php echo number_format ($row_in['peso'] * $row_in['v_kilo']); ?></td>
        <td><?php echo $row_in['factura']; ?></td>
      </tr>
