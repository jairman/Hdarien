...
<script src="../js/compras_fact.js" type="text/javascript"></script>
...
<table width="98%" border="1" cellspacing="0" align="center">
    <tr>
      ...
      <td align="center" class="cont" width="30%">
        <label><?= $row_fact['punto_venta']?></label>
      </td>
      <td class="bold" width="20%">Fecha</td>
      <td width="30%" align="center" class="cont"><label><?= $row_fact['f_fact']?></label></td>
    </tr>
    <tr>
      ...
      <td align="center" class="cont"><label><?= $row_fact['ced']?></label></td>
    </tr>
    <tr>
      <td class="bold" >Telefono</td>
      <td align="center" class="cont"><label><?= $row_fact['tel']?></label></td>
      <td class="bold" >Forma de Pago</td>
      <td align="center" class="cont"><label><?= $row_fact['forma_pago']?></label></td>
    </tr>
    <tr>
      <td class="bold" width="20%">Fecha Pago</td>
      <td align="center" class="cont"><label><?= $row_fact['f_pago']?></label></td>
      <td class="bold" >Pedido No</td>
      <td align="center" class="cont"><label><?= $row_fact['ped']?></label></td>
    </tr>
    <tr id="fila_con">
      <td class="bold" width="20%">Observaciones</td>
      <td align="center" class="cont" colspan="3">
        <label><?= $row_fact['obs']?></label>
      </td>
    </tr>
  </table>
  ...
  <tr id="fila_<?= $i?>" class="row">
    ...
    <td class="cont" align="center">
    <label><?= number_format($row_prod['costo'],2) ?></label>
    </td>
    <td class="cont" align="center">
	<label><?= number_format($row_det['precio_und'],2) ?></label>
    </td>
...
<table width="98%" border="1" cellspacing="0" align="center">
  <tr>
    ...
    <td width="30%" class="bold"><label id="lb_toti" class="red"><?= $row_fact['cant']?></label></td>
    <td width="20%" class="bold">Total</td>
    <td width="30%" class="bold"><label id="lb_totc" class="red"><?= number_format($row_fact['costo'],2)?></label></td>
  </tr>
  <tr>
