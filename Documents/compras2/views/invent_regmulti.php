...
<table width="98%" border="1" cellspacing="0" cellpadding="0" align="center">
    ...
    <div align="center" id="<?php echo $id ?>" style="width:125px; height:125px; float:left;" name=divs>
        <div>
        <img src="../controllers/invent_agregarimg.php?idnum=<?php echo $id ?>" alt="Img" id="art<?php echo $id ?>" name="imgs" class="picture" />
        </div>
    ...
    class="ext"onClick="guardar(); return false">
    &nbsp;
