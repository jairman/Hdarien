...
<script src="../js/compras_fact1.js" type="text/javascript"></script>
...
<table width="98%" align="center" id="table_header">
  ...
  <?php
  mysql_select_db($database_conexion, $conexion);
  $prod = mysql_query("SELECT * FROM `h01sg_inventario_detalle_anul` WHERE `consec`='$consec_url' 
  ...
  <tr id="fila_<?php echo $i?>" class="row">
    ...
    <!--<td class="cont">
    <label>< echo $row_det['cod_barra'] ?></label>
    </td>-->
    <td class="cont">
    <label><?php  
	$string = $row_det['desc']; 
    ...
    <td class="cont" align="center">
    <label><?php 
	echo number_format($row_prod['costo'],2) ?></label>
    </td>
    <td class="cont" align="center">
    <label><?php 
	echo number_format($row_det['precio_und'],2) ?></label>
    </td>
