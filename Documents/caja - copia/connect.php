...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	
$insertar = mysql_query("INSERT INTO d89xz_diario(`concep`,`comentario`,`estado`,`valor`,`fecha`,`cliente`,`factura`,`cedula`,`f_alarma`,`user`,`hacienda`,`f_pago`  , `devolucion`) VALUES ('{$concepto}','{$descrip}','{$estado}','{$valor_t}','{$fecha}','{$cliente}','{$factura}','{$cedula}','{$fechapago}','{$usuario2}','{$sucursal}','{$formapago}'  ,4 )",$conexion);
////  2 
//////////////////////-------------------------------------------------------------------------------//////////////////////////////////////
if($estado==Pendiente){
