...
<table width="95%" border="0" align="center" cellspacing="0">
  <tr bgcolor="#f0f0f0">
    <td width="858" align="left" bgcolor="#FFFFFF"><div id="menu">
      <ul >
        <ul>
          <li> <a href="dia_dia_pendiente.php"  class='active'>Cuentas Por Cobrar</a> </li>
           <li><a href="dia_dia_pendiente1.php"  >Cuentas Por Pagar</a></li>
...
<DIV ID="seleccion">
  ...
  <tr  class="tittle">
<td colspan="7" >Cuentas Por Cobrar</td>
</tr>
<tr  class="subtitle">
  <td width="192" >Punto de Venta</td>
  <td width="240" align="center" ><?php
		echo @$hda=$_GET['hda'];
  ...
  <td align="left" ><input  name="tf_fecha" type="text" id="tf_fecha" style="width:80%"  value="<?php echo date('Y-m-d') ?>" /> </td>
  <td align="left" >&nbsp; Hasta &nbsp;</td>
  <td align="left" ><input  name="tf_fecha2" type="text" id="tf_fecha2" style="width:80%"       oninvalid="setCustomValidity('Esta fecha debe ser MAYOR  a la Inicial')"    value="<?php echo date('Y-m-d') ?>"/></td>
  </tr>
</table>
 ...
 $usuario_nivel;
	  if($usuario_nivel !='general'){
		      ...
		      if( $usuario_nivel !=''   &&  $f2 =='' ){
	  		 ...
	  		 $query_pen = "SELECT DISTINCT factura,cliente,estado,comentario,hacienda,f_pago,concep,f_alarma ,fecha,consec_fact  FROM d89xz_diario WHERE   estado = 'Pendiente' and  concep='Ingreso' and	hacienda='$usuario_nivel'         ORDER BY factura desc";
			  }
	    ...
	    if( $usuario_nivel!='general'   &&  $f2 !='' ){
			...
			$query_pen = "SELECT DISTINCT factura,cliente,estado,comentario,hacienda,f_pago,concep,f_alarma       		    				,fecha,consec_fact  FROM d89xz_diario WHERE      estado = 'Pendiente'   
						 and  concep='Ingreso' and    hacienda='$usuario_nivel' and    fecha >= '$f1'  AND  fecha <='$f2'                          ORDER BY factura desc"; 	
	    ...
	    if($usuario_nivel =='general'){
		 // echo $usuario_nivel;
					...
					//echo "1";
						$query_pen = "SELECT DISTINCT factura,cliente,estado,comentario,hacienda,f_pago,concep,f_alarma ,fecha,consec_fact  FROM d89xz_diario WHERE  estado = 'Pendiente'   
						 and   concep='Ingreso' and   hacienda='$hda'   and    fecha >= '$f1'  AND  fecha <='$f2'   ORDER BY factura desc"; 
				  }
				...
				if($hda ==' ' && $f2 !='' ) {
					//echo "2";
						$query_pen = "SELECT DISTINCT factura,cliente,estado,comentario,hacienda,f_pago,concep,f_alarma ,fecha,consec_fact  FROM d89xz_diario WHERE  estado = 'Pendiente'   
						 and  concep='Ingreso' and  fecha >= '$f1'  AND  fecha <='$f2'   ORDER BY factura desc"; 
				  }
				  
				  
				  if( $hda ==''   && $f2 =='' ){
				 //echo "3";
						$query_pen = "SELECT DISTINCT factura,cliente,estado,comentario,hacienda,f_pago,concep,f_alarma ,fecha,consec_fact  FROM d89xz_diario WHERE      estado = 'Pendiente'   and                          concep='Ingreso' 					   ORDER BY factura desc"; 	
					...
					//	 echo "4".$usuario_nivel;
						$query_pen = "SELECT DISTINCT factura,cliente,estado,comentario,hacienda,f_pago,concep,f_alarma ,fecha,consec_fact  FROM d89xz_diario WHERE      estado = 'Pendiente'   
						 and  concep='Ingreso' and    hacienda='$hda'    ORDER BY factura desc"; 	
...
<table width="99%" border="1" align="center" cellspacing="0" id="t_suma">
  ...
  do {
      ...
      <tr class="row" align="center" >
        <td   align="center" onClick="mostrar('fact.php?c=<?php echo $row_pen['consec_fact'] ?>&p=<?php echo $row_pen['hacienda'] ?>&factura=<?php echo $row_pen['factura'] ?>')"><?php echo $row_pen['fecha']; ?></td>
      <td   align="center" onClick="mostrar('fact.php?c=<?php echo $row_pen['consec_fact'] ?>&p=<?php echo $row_pen['hacienda'] ?>&factura=<?php echo $row_pen['factura'] ?>')"><?php echo $row_pen['factura']; ?></td>
      <td   align="center" onClick="mostrar('fact.php?c=<?php echo $row_pen['consec_fact'] ?>&p=<?php echo $row_pen['hacienda'] ?>&factura=<?php echo $row_pen['factura'] ?>')" ><?php echo $row_pen['f_alarma']; ?></td>
      <td   align="center" onClick="mostrar('fact.php?c=<?php echo $row_pen['consec_fact'] ?>&p=<?php echo $row_pen['hacienda'] ?>&factura=<?php echo $row_pen['factura'] ?>')" >&nbsp; <?php echo $row_pen['cliente']; ?></td>   
      <td  align="center" onClick="mostrar('fact.php?c=<?php echo $row_pen['consec_fact'] ?>&p=<?php echo $row_pen['hacienda'] ?>&factura=<?php echo $row_pen['factura'] ?>')" >&nbsp; <?php echo $row_pen['comentario']; ?></td>
      <td  align="center" onClick="mostrar('fact.php?c=<?php echo $row_pen['consec_fact'] ?>&p=<?php echo $row_pen['hacienda'] ?>&factura=<?php echo $row_pen['factura'] ?>')" ><?php echo $row_pen['hacienda']; ?></td>
      <td  align="right" onClick="mostrar('fact.php?c=<?php echo $row_pen['consec_fact'] ?>&p=<?php echo $row_pen['hacienda'] ?>&factura=<?php echo $row_pen['factura'] ?>')"><?php 
...
/*____________________________________________________________________________________________________________*/		
      ...
      <td  class="row" align="center" style="font-weight: bold" onClick="mostrar('detalle_abono.php?factura=<?php echo $row_pen['factura']; ?>&hacienda=<?php echo $row_pen['hacienda']; ?>&concep=<?php echo $row_pen['concep']; ?>&cliente=<?php echo $row_pen['cliente']; ?>')"><img src="../img/Calculator.png" width="25" height="25" title="Abonar"  class="calc"/></td>
    </tr>
        <?php 
