...
<table width="98%" border="0" align="center" cellspacing="0">
  <tr bgcolor="#f0f0f0">
    <td width="858" align="left" bgcolor="#FFFFFF"><div id="menu">
      <ul >
        <ul>
          <li> <a href="dia_dia_pendiente.php"  class='active'>Crédito Ingreso</a> </li>
           <li><a href="dia_dia_pendiente1.php"  >Crédito Egreso</a></li>
 ...
 $usuario_nivel;
	  if($usuario_nivel !='general'){
		      ...
		      if( $usuario_nivel !=''   &&  $f2 =='' ){
				  ...
				  // echo 1;
	  		 $query_pen = "SELECT DISTINCT factura,cliente,estado,comentario,hacienda,f_pago,concep,f_alarma ,fecha  FROM d89xz_diario WHERE   estado = 'Pendiente' and      
			    			      				concep='Ingreso' and		hacienda='$usuario_nivel'    and    fecha >= '$f1' AND fecha <='$f2'     ORDER BY factura desc";
			  }
	    ...
	    if( $usuario_nivel!=''   &&  $f2 !='' ){
					// echo "2".$usuario_nivel;
						$query_pen = "SELECT DISTINCT factura,cliente,estado,comentario,hacienda,f_pago,concep,f_alarma ,fecha  FROM d89xz_diario WHERE      estado = 'Pendiente'   
	    ...
	    if($usuario_nivel ='general'){
		 // echo $usuario_nivel;
				...
				if($hda ==' ' && $f2 !='' ) {
				  ...
				  if( $hda ==''   && $f2 =='' ){
				 //echo "3";
						$query_pen = "SELECT DISTINCT factura,cliente,estado,comentario,hacienda,f_pago,concep,f_alarma ,fecha  FROM d89xz_diario WHERE      estado = 'Pendiente'   and                          concep='Ingreso' 					   ORDER BY factura desc"; 	
...
<table width="99%" border="1" align="center" cellspacing="0" id="t_suma">
  ...
  do {
      ...
      <tr class="row" align="center" >
        <td   align="center" ><?php echo $row_pen['fecha']; ?></td>
      <td   align="center" ><?php echo $row_pen['factura']; ?></td>
      <td   align="center" ><?php echo $row_pen['f_alarma']; ?></td>
      <td   align="center" >&nbsp; <?php echo $row_pen['cliente']; ?></td>   
      <td  align="center" >&nbsp; <?php echo $row_pen['comentario']; ?></td>
      <td  align="center" ><?php echo $row_pen['hacienda']; ?></td>
      <td  align="right" ><?php 
