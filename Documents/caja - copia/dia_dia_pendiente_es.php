	  ...
	  if($usuario_nivel !='general'){
		      ...
		      if( $usuario_nivel !=''   &&  $f2 =='' ){
	  		 ...
	  		 $query_pen = "SELECT DISTINCT factura,cliente,estado,comentario,hacienda,f_pago,concep,f_alarma ,fecha,consec_fact  FROM d89xz_diario WHERE   estado = 'Pendiente' and      
			    			      				concep='Ingreso' and		hacienda='$usuario_nivel'         ORDER BY factura desc";
			  }
...
<table width="99%" border="1" align="center" cellspacing="0" id="t_suma">
  ...
  do {
      ...
      <tr class="row" align="center" >
        <td   align="center" onClick="mostrar('fact.php?c=<?php echo $row_pen['consec_fact'] ?>&p=<?php echo $row_pen['hacienda'] ?>')"><?php echo $row_pen['fecha']; ?></td>
      <td   align="center" onClick="mostrar('fact.php?c=<?php echo $row_pen['consec_fact'] ?>&p=<?php echo $row_pen['hacienda'] ?>')"><?php echo $row_pen['factura']; ?></td>
      <td   align="center" onClick="mostrar('fact.php?c=<?php echo $row_pen['consec_fact'] ?>&p=<?php echo $row_pen['hacienda'] ?>')" ><?php echo $row_pen['f_alarma']; ?></td>
      <td   align="center" onClick="mostrar('fact.php?c=<?php echo $row_pen['consec_fact'] ?>&p=<?php echo $row_pen['hacienda'] ?>')" >&nbsp; <?php echo $row_pen['cliente']; ?></td>   
      <td  align="center" onClick="mostrar('fact.php?c=<?php echo $row_pen['consec_fact'] ?>&p=<?php echo $row_pen['hacienda'] ?>')" >&nbsp; <?php echo $row_pen['comentario']; ?></td>
      <td  align="center" onClick="mostrar('fact.php?c=<?php echo $row_pen['consec_fact'] ?>&p=<?php echo $row_pen['hacienda'] ?>')" ><?php echo $row_pen['hacienda']; ?></td>
      <td  align="right" onClick="mostrar('fact.php?c=<?php echo $row_pen['consec_fact'] ?>&p=<?php echo $row_pen['hacienda'] ?>')"><?php 
