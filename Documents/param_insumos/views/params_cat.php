...
<head>
<meta charset="UTF-8">
<title>Parametrización Categoria</title>
...
<script src="../js/params_cat.js" type="text/javascript"></script>
...
<div id="dialog"></div>
<div id="dialog2" title="Edición Categoria">
...
<div id="dialog3" title="Crear Categoria">
<table align="center" width="90%">
<tr>
	<td align="right" class="bold" width="50%">Identificador</td>
...
<table width="90%" border="1" cellspacing="0" align="center">
    <tr class="tittle">
    <td>Parametrización Categorias</td>
    </tr>
</table>
...
<table width="90%" border="1" cellspacing="0" align="center" id="tb_detail">
  <tr class="stittle" id="tittle">
    <td width="45%" onClick="orden_bus('cat')" style="cursor:pointer" title="Ordenar por Categoria">Categoria</td>
  ...
  <?php
	...
	$query_inv = mysql_query("SELECT * FROM `h01sg_categoria_insumo` WHERE `delete`<>1 $order_url", $conexion) or die(mysql_error());		
	while($row_inv = mysql_fetch_assoc($query_inv)){
		
  ?>
  <tr class="row" id="fila_<?php echo $i?>" >
    <td align="center"><?php echo $row_inv['cat']?></td>
    ...
    <td align="center"><input name="imgb" type="image" id="img<? echo $i; ?>" 
      ...
      onClick="edit('<?php echo $row_inv['cat'] ?>', '<?php echo $row_inv['nombre']?>')" >
      &nbsp;
      ...
      onClick="erase('<?php echo $row_inv['cat'] ?>')" >
      </td>
  </tr>
  <?php
  $i++;
