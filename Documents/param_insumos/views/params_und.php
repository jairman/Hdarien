...
<head>
<meta charset="UTF-8">
<title>Parametrización Unidades de Medida</title>
...
<script src="../js/params_und.js" type="text/javascript"></script>
...
<div id="dialog"></div>
<div id="dialog2" title="Edición Unidad">
...
<div id="dialog3" title="Crear Unidad">
<table align="center" width="90%">
<tr>
	<td align="right" class="bold" width="50%">Identificador</td>
  ...
  <tr>
    <td width="76%" align="left">
     <div id="menu">
      <ul>
      <li>
      <a href="../../produccion/controllers/listaprocesos.php" >Procesos</a>
      </li>              
      <li>
        <a href="../../produccion/controllers/listacolores.php" >Colores</a>
      </li>
      <li>
      <a href="../views/params_und.php" class='active'>Unidad de Medida</a>
      </li>              
      <li>
        <a href="../views/params_cat.php" >Categoría</a>
      </li>
      </ul>
    </div>  
    </td>
...
<table width="90%" border="1" cellspacing="0" align="center">
    <tr class="tittle">
    <td>Parametrización Unidades de Medida</td>
    </tr>
</table>
...
<table width="90%" border="1" cellspacing="0" align="center" id="tb_detail">
  <tr class="stittle" id="tittle">
    <td width="45%" onClick="orden_bus('und')" style="cursor:pointer" title="Ordenar por Unidad de Medida">Unidad</td>
  ...
  <?php
	...
	$query_inv = mysql_query("SELECT * FROM `h01sg_unidad_insumos` WHERE `delete`<>1 $order_url", $conexion) or die(mysql_error());		
	while($row_inv = mysql_fetch_assoc($query_inv)){
		
  ?>
  <tr class="row" id="fila_<?php echo $i?>" >
    <td align="center"><?php echo $row_inv['und']?></td>
    ...
    <td align="center"><input name="imgb" type="image" id="img<? echo $i; ?>" 
      ...
      onClick="edit('<?php echo $row_inv['und'] ?>', '<?php echo $row_inv['nombre']?>')" >
      &nbsp;
      ...
      onClick="erase('<?php echo $row_inv['und'] ?>')" >
      </td>
  </tr>
  <?php
  $i++;
