...
<script src="../js/insumos_mov.js" type="text/javascript"></script>
...
<table width="95%" align="center" id="table_header">
  <tr>
    ...
    <div id="menu">
      <ul>
      <li>
      <a href="insumos_ficha.php?r=<?php echo $ref_url ?>" >Ficha del Insumo</a>
      </li>
      <li>
      <a  href="insumos_mov.php?r=<?php echo $ref_url ?>" class='active'>Historial de movimientos</a>
      </li>
      </ul>
    </div>   
    </td>
