...
$fecha=$_GET['fecha'];
$valor=$_GET['id'];
$query_edt = "SELECT * FROM d89xz_notas WHERE id = $valor";
...
$insertar = mysql_query("UPDATE d89xz_notas SET  estado='Cumplida' WHERE id='$valor'",$conexion);


echo "<script type=''>
		window.location='index_hh.php';
	</script>";
