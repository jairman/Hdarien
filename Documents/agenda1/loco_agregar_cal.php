...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="twoDates">
  <table width="70%"  align="center" cellspacing="0">
    ...
    <tr >
      ...
      <td width="302" class="cont"><input type="text" name="tarea" value="" style="width:94%"/></td>
    </tr>
    <tr >
      <th align="left" class="bold">Tipo De Actividad</th>
      <td class="cont"><input type="text" name="comen" value="" style="width:94%" /></td>
    </tr>
    <tr >
      <th align="left" class="bold">Hora</th>
      <td class="cont"><span id="sprytextfield1">
      <label for="hora"></label>
      <input name="hora" type="text" id="hora" style="width:94%" />
    ...
    <tr >
      ...
      <td class="cont"><input  name="datepicker" type="text" id="datepicker" style="width:94%"  value="<?php echo date('Y-m-d') ?>" /></td>
    </tr>
    <tr >
