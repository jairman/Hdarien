...
<table width="98%" align="center">
  <tr>
    <td width="84%" align="right"><p class="s">&nbsp;</p></td>
    <td width="6%" align="center"><img src="../../img/addpersonas.png" width="40" height="40" title="Agregar Nuevo" 
   		 style="cursor:pointer"  onclick="agregar()"  /></td>
	<td width="5%" align="center"><img src="../../img/Excell_Up.png" alt="" width="40" height="40" 
   		 style="cursor:pointer" title="Agregar Excel"  onclick="agregar_excel()"  /></td>
    <td width="5%" align="center"><img  title="Imprimir" src="../../img/imprimir.png" alt="" 
...
<div id="registros"> 
          ...
          <table width="98%" id="Table_Resultadohistorial">             
            <tr class="tittle">
                <td colspan="8"><p>Listado De Proveedores</p></td>
            </tr>   
                <td colspan="4">
...
<tr class="stittle">
      <td width="7%"><span ng-click="ordenarPor('cedula')">NIT</span>
         			  <span class="fa fa-angle-down" ng-click="ordenarPor('-cedula')"></span></td>
      <td width="27%"><span ng-click="ordenarPor('nombre')">Nombre</span>
                      <span class="fa fa-angle-down" ng-click="ordenarPor('-nombre')"></span></td>
      <td width="16%"><span ng-click="ordenarPor('contacto1')">Contacto</span>
      				  <span class="fa fa-angle-down" ng-click="ordenarPor('-contacto1')"></span></td>
      <td width="8%"><span ng-click="ordenarPor('cel')">Celular</span>
                      <span class="fa fa-angle-down" ng-click="ordenarPor('-cel')"></span></td>
      <td width="7%"><span ng-click="ordenarPor('categoria')">Categoría</span>
      				 <span class="fa fa-angle-down" ng-click="ordenarPor('-categoria')"></span></td>
      <td width="7%"><span ng-click="ordenarPor('tipo')">Producto</span>
      				<span class="fa fa-angle-down" ng-click="ordenarPor('-tipo')"></span></td>
      				 
      <td width="12%"><span ng-click="ordenarPor('mail')">Email</span>
      ...
      <td width="6%">&nbsp;</td>                  
              ...
              <tr dir-paginate="meal in meals | filter:q | itemsPerPage: pageSize | orderBy:ordenSeleccionado" current-page="currentPage" class="row-m">
                  ...
                  <td align="center" ng-click="buscar(meal.id)">{{meal.contacto1}}</td>
                  <td align="center" ng-click="buscar(meal.id)">{{meal.cel}}</td>
                  <td align="center" ng-click="buscar(meal.id)">{{meal.categoria}}</td>
                  <td align="center" ng-click="buscar(meal.id)">{{meal.tipo}}</td>
