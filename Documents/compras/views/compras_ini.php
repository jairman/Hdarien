...
<table width="95%" align="center">
    ...
    <div id="menu">
      ...
      <li>
      <a  href="compras_ini.php" class='active'>Compras</a>
      </li>
      </ul>
    </div>  
    </td>
...
<table width="95%" align="center" id="tb_data">
  ...
  while($row_muerte = mysql_fetch_assoc($muerte)){
    ...
    <td align="center" 
    onClick="mostrar('../views/compras_fact1.php?c=<?php echo $row_muerte['consec'] ?>')">
	...
	<tr  id="fila_<?php echo $i?>" class="row">
    <td align="center" 
    onClick="mostrar('../views/compras_fact3.php?c=<?php echo $row_muerte['consec'] ?>')">
	<?php echo $row_muerte['f_fact']?></td>
    <td align="center" 
    onClick="mostrar('../views/compras_fact3.php?c=<?php echo $row_muerte['consec'] ?>')">
	<?php echo $row_muerte['consec']?></td>
    ...
    onClick="mostrar('../views/compras_fact3.php?c=<?php echo $row_muerte['consec'] ?>')">
	<label id="lb_costo<?php echo $i?>" class="costo"><?php echo number_format($row_muerte['costo'], 2)?></label></td>
    <td align="center" ><input name="imgb" type="image" id="img<?php echo $i; ?>" 
      src="../../img/edit.png" width="20" height="20" class="bt_x" style="cursor:pointer" title="Editar"
      onClick="editari('<?php echo $row_muerte['consec'] ?>')" >
      &nbsp;
      ...
      onClick="quitari('<?php echo $row_muerte['consec']?>','<?php echo $i; ?>')" >
    </td>    
  </tr>
	<?php	
		$i++;  
	...
	<tr  id="fila_<?php echo $i?>" class="row">
    <td align="center" 
    onClick="mostrar('../views/compras_fact4.php?c=<?php echo $row_muerte['consec'] ?>')">
	<?php echo $row_muerte['f_fact']?></td>
    <td align="center" 
    onClick="mostrar('../views/compras_fact4.php?c=<?php echo $row_muerte['consec'] ?>')">
	<?php echo $row_muerte['consec']?></td>
  ...
  <tr  id="fila_<?php echo $i?>" class="row">
    <td align="center" 
    onClick="mostrar('../views/compras_fact.php?c=<?php echo $row_muerte['consec'] ?>')">
	<?php echo $row_muerte['f_fact']?></td>
    <td align="center" 
    onClick="mostrar('../views/compras_fact.php?c=<?php echo $row_muerte['consec'] ?>')">
	<?php echo $row_muerte['consec']?></td>
  ...
  <?php
	...
	<tr  id="fila_<?php echo $i?>" class="row">
    <td align="center" 
    onClick="mostrar('../views/compras_fact2.php?c=<?php echo $row_muerte['consec'] ?>')">
	<?php echo $row_muerte['f_fact']?></td>
    <td align="center" 
    onClick="mostrar('../views/compras_fact2.php?c=<?php echo $row_muerte['consec'] ?>')">
	<?php echo $row_muerte['consec']?></td>
