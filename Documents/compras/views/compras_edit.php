...
<table width="98%" border="1" cellspacing="0" align="center">
  ...
  <tr id="fila_<?php echo $i?>" class="row"> 
    ...
    <input type="text" class="long" id="tf_codb<?php echo $i?>" value="<?php echo $row_det['cod_barra'] ?>" readonly>
    </td>
    <td class="cont" id="td_rfid<?php echo $i?>">
    <input type="text" class="long" id="tf_rfid<?php echo $i?>" value="<?php echo $row_det['rfid'] ?>" readonly>
    </td>
    <td class="cont">
    ...
    <input type="text" class="long" id="tf_talla<?php echo $i?>" value="<?php echo $row_det['talla'] ?>" readonly>
    </td>
    ...
    <input type="text" class="long" id="tf_scat<?php echo $i?>" value="<?php echo $row_det['sub_cat'] ?>" readonly>
    </td>
    <td class="cont">
