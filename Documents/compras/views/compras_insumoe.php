...
<script src="../js/compras_insumoe.js" type="text/javascript"></script>
<style>
.picture{
	width:80px;
	height:80px;
...
<table width="98%" border="1" cellspacing="0" align="center">
  ...
  <tr id="fila_<?php echo $i?>" class="row"> 
    ...
    <td class="cont">
    <input type="text" class="long" id="tf_desc<?php echo $i?>" value="<?php echo $row_det['desc'] ?>" readonly>
    </td>
    <td class="cont">
    <input type="text" class="long" id="tf_pre<?php echo $i?>" value="<?php echo $row_det['present'] ?>" readonly>
    </td>
    <td class="cont">
    <input type="text" class="long" id="tf_cont<?php echo $i?>" value="<?php echo $row_det['contenido'] ?>" readonly>
    </td>
    <td class="cont">
    <input type="text" class="long" id="tf_undm<?php echo $i?>" value="<?php echo $row_det['unidad'] ?>" readonly>
    </td>
    <td class="cont">
    <input type="text" class="long" id="tf_cod<?php echo $i?>" value="<?php echo $row_det['codigo'] ?>" readonly>
    </td>
    <td class="cont" id="td_color<?php echo $i?>">
    <input type="text" class="long" id="tf_color<?php echo $i?>" value="<?php echo $row_det['color'] ?>" readonly>
    </td>
    <td class="cont" id="td_marca<?php echo $i?>">
    <input type="text" class="long" id="tf_marca<?php echo $i?>" value="<?php echo $row_det['marca'] ?>" readonly>
    </td>
    <td class="cont">
    <input type="text" class="long" id="tf_cat<?php echo $i?>" value="<?php echo $row_det['categoria'] ?>" readonly>
    </td>
    <td class="cont">
    <input type="text" id="tf_cant<?php echo $i?>" class="long cant" required onkeyup="checkNum(this)" 
    onChange="totcosto()" value="<?php echo $row_prod['cant'] ?>">
    <input type="hidden" id="tf_canti<?php echo $i?>">
    ...
    onChange="totcosto(),changeCosto1()" value="<?php echo $row_det['costo_und'] ?>">
    </td>
    <td class="cont">
    <input type="text" id="tf_costoemp<?php echo $i?>" class="long" required onkeyup="checkNum(this)" 
    onChange="totcosto(),changeCosto2()"  >
    </td>
    <td align="center">
