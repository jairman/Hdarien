...
<script src="../js/invent_prod.js" type="text/javascript"></script>
<style>
.picture{
	width:80px;
	height:80px;
...
<table width="95%" align="center">
    ...
    <div id="menu">
      <ul>
      <li>
      <a href="../views/invent_prod.php" class='active'>Productos</a>
      </li>
      <li>
      <a  href="../views/compras_insumo.php" >Insumos</a>
      </li>
      </ul>
    </div>  
    </td>
