...
function load1(){
	...
	$('#d_table').load('compras_isearch.php?id=' + id.replace(/ /g,"+") + '&i=' + i.replace(/ /g,"+") + 
	'&p=' + p.replace(/ /g,"+") + '&o=' + o.replace(/ /g,"+") + '&x=' + x.replace(/ /g,"+") + ' #d_table ' );
}
...
function load2(order){
	...
	//console.log('id:'+id+' i:'+i)
	$('#d_table').load('compras_isearch.php?id=' + id.replace(/ /g,"+") + '&i=' + i.replace(/ /g,"+") + 
	'&p=' + p.replace(/ /g,"+") + '&o=' + order.replace(/ /g,"+") + '&x=' + x.replace(/ /g,"+") + ' #d_table ' );
}
