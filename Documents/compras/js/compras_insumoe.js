...
function searchp(){
	...
	setTimeout(function () {
		...
		var url = '../views/compras_isearch.php?i='+j+'&x=j';
		console.log(url)
		Shadowbox.open({
			content: url,
			player: "iframe",
...
function agregarFila(){
	...
	string = string+'<td class="cont"><input type="text" id="tf_pre'+j+'" class="long" ></td>';
	string = string+'<td class="cont"><input type="text" id="tf_cont'+j+'" class="long" ></td>';
	string = string+'<td class="cont"><select id="tf_undm'+j+'" class="long" ><option value="">Seleccione</option>';
	for(var x = 0; x < unid.length;x++){
		string = string+'<option value="'+unid[x].und+'">'+unid[x].nombre+'</option>';
	}
	string = string+'</select></td>';
	string = string+'<td class="cont"><input type="text" id="tf_cod'+j+'" class="long" ></td>';
	...
	string = string+'<td class="cont"><select id="tf_cat'+j+'" class="long"><option value="">Seleccione</option>';
	for(var z = 0; z < categ.length;z++){
		string = string+'<option value="'+categ[z].cat+'">'+categ[z].nombre+'</option>';
	}
	string = string+'</select></td>';
	string = string+'<td class="cont"><input type="text" id="tf_cant'+j+'" class="long cant" required onkeyup="checkNum(this)" onChange="totcosto()" ><input type="hidden" id="tf_canti'+j+'"></td>';
	string = string+'<td class="cont"><input type="text" id="tf_costo'+j+'" class="long costo" required onkeyup="checkNum(this)" onChange="totcosto(),changeCosto1()" ></td>';
	string = string+'<td class="cont"><input type="text" id="tf_costoemp'+j+'" class="long" required onkeyup="checkNum(this)" onChange="totcosto(),changeCosto2()" ></td>';
...
function createrow(id){
	...
	string = string+'</select></td>';
	string = string+'<td class="cont"><input type="text" id="tf_cant'+j+'" class="long cant" required onkeyup="checkNum(this)" onChange="totcosto()" ><input type="hidden" id="tf_canti'+i+'"></td>';
	string = string+'<td class="cont"><input type="text" id="tf_costo'+j+'" class="long costo" required onkeyup="checkNum(this)" onChange="totcosto(),changeCosto1()" ></td>';
	string = string+'<td class="cont"><input type="text" id="tf_costoemp'+j+'" class="long" required onkeyup="checkNum(this)" onChange="totcosto(),changeCosto2()" ></td>';
	string = string+'<td align="center"><img src="../../img/erase.png" id="img'+j+'" width="20" height="20" style="cursor:pointer;" title="Eliminar" onClick="quitar('+j+')"></td>';
	string = string+'</tr>';
...
function envia(j){
	...
	var user2 = $('#tf_user2').val();
	var puntov = $('#tf_ptov').val();
	console.log({vals4: regs, j:i, tam_env:tam_env, consec:consec, fecha:fecha, user:user2, ptov:puntov})
	$.ajax({
		type: "POST",		
		url: "../controllers/arreglo.php",
		dataType: "json",
		data: {vals4: regs, j:i, tam_env:tam_env, consec:consec, fecha:fecha, user:user2, ptov:puntov},
		success: function(datos){ 
			console.log(datos);
			window.maximo++;
			iteracionesb++
