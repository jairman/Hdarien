...
<table width="98%" border="1" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr class="row">
    <td align="left" ><strong>Nota: </strong>El Formato de Fecha Debe Ser YYYY-MM-DD</td>
  </tr>
  <tr class="row">
  ...
  <tr class="row">
    <td align="left" ><strong>Nota:</strong> Descargue el Formato Para Importar Desde Excel<a href="formato/clientes_excel.xlsx" id="button-download" ><img src="../img/Download-Folder-icon.png" width="20" height="20" id="image"/></a></td>
  </tr>
  <tr class="tittle">
