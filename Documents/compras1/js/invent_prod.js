...
function draw(obj){
	...
	for(var j = 0; j < obj.length; j++){
		...
		if (!exist){
			...
			string = string+'<td class="cont" id="td_marca'+i+'"><input type="text" id="tf_marca'+i+'" class="long" value="'+obj[j][5]+'"></td>';
			string = string+'<td class="cont" id="td_color'+i+'"><input type="text" id="tf_color'+i+'" class="long" value="'+obj[j][6]+'"></td>';
			string = string+'<td class="cont" id="td_cat'+i+'"><input type="text" id="tf_cat'+i+'" class="long" value="'+obj[j][7]+'"></td>';
...
function searchp(){
	...
	//console.log('../inventario/invent_psearch.php?i='+i)
	var url = '../compras/invent_psearch.php?i='+i;
	Shadowbox.open({
		content: url,
		player: "iframe",
		options: {                   
...
function agregarFila(){
	...
	string = string+'<td class="cont" id="td_cat'+i+'"><input type="text" id="tf_cat'+i+'" class="long"></td>';
