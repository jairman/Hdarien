...
<table width="90%" border="1" align="center">
  <tr class="stittle">
    ...
    <td width="20%" onClick="orden_bus('desc')" style="cursor:pointer" title="Ordenar por Descripción">Descripcion</td>
...
function load1(){
	...
	$('#d_table').load('invent_psearch.php?id=' + id.replace(/ /g,"+") + '&i=' + i.replace(/ /g,"+") + '&p=' + p.replace(/ /g,"+") + '&o=' + o.replace(/ /g,"+") + ' #d_table ' );
}
...
function load2(order){
	...
	var id = $('#tf_idr').val();
	//console.log('id:'+id+' i:'+i)
	$('#d_table').load('invent_psearch.php?id=' + id.replace(/ /g,"+") + '&i=' + i.replace(/ /g,"+") + '&p=' + p.replace(/ /g,"+") + '&o=' + order.replace(/ /g,"+") + ' #d_table ' );
}

function insertprod(ref, x){
	//var ref = $('#tf_ref').val();
	var i = parent.$('#tf_i').val();
