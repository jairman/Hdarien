...
<head>
  ...
  <script src="../js/repetidos.js"></script>
...
<body>
        ...
        <div ng-controller="MyController" class="my-controller" id="historialEventos">
            <table width="90%" align="center" id="table_header">
              <tbody><tr>
                ...
                <div id="menu">
                  <ul>
                  <li>
                    <a href="reportes.php" class="menur">Eventos</a>
                  </li>  
                  <li>
                    <a href="repetidos.php" class="menur active">Eventos peridodicos</a>
                  </li>                           
                  <li>
            ...
            <tr class="stittle style-font">
              ...
              <tr dir-paginate="meal in meals | filter:q | itemsPerPage: pageSize | orderBy:ordenSeleccionado" current-page="currentPage" class="row-m style-font">
