<!--Template principal de la agenda
...
<img src="http://$_SERVER[HTTP_HOST]/administrativo/img/Logo.png" alt="logo" name="logo" width="200" height="70" id="logo" />
        ...
        <table align="center">
           ...
           <td width="40%" align="left">
            ...
            <img src="../../../img/Logo.png" id="logo" class="logo" alt="" width="200" height="70">
                <div class="tittle">               
                 <div class="control">
                    <a onclick="siguienteFecha(-1)" class="anterior" tittle="Dia anterior"><img src="../../img/back.png" width="25" height="25" alt=""></a>
                    <a class="titulo"></a>
                    <a onclick="siguienteFecha(1)" class="siguiente" title="Dia siguiente"><img src="../../img/next.png" width="25" height="25" alt=""></a>
                    </div>
                </div>
                <div id="listaA"> 
                </div>
