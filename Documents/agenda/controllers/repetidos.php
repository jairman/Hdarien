...
este es el archivo es controlador de la vista para mostrar los eventos repetidos, el cual se encarga de llamar 
...
include ('../views/acceso.php');//vista que informa al user que debe estar logueado
    ...
    include('../views/repetidos.php');//esta vista muestra el resto de informacion del formulario
}