...
WHERE `delete`<>1 AND `consec`='$consec_url' ", $conexion) or die(mysql_error());
...
<script src="js/cierre_edit.js" type="text/javascript"></script>
...
<table width="100%" border="1" cellspacing="0" align="center">   
 	<tr>
      ...
      <td width="30%" class="cont bold"><label id="lb_consec" class="red"><?php echo $consec_url?></label></td> 
        <td align="center" class="bold" width="20%">Marca</td>
    <td class="cont bold" width="30%"><label class="red" id="lb_marca"><?php echo $row_cierre['marca']?></label></td> 
  </tr>
    <tr>
    <td align="center" class="bold" width="20%">Punto de Venta</td>
    <td class="cont bold" width="30%"><label class="red" id="lb_ptov"><?php echo $row_cierre['punto_venta']?></label></td> 
...
<table width="100%" border="1" cellspacing="0" align="center" id="tb_detail">
  ...
  <?php
	...
	WHERE `delete`<>1 AND `consec`='$consec_url' ORDER BY `ref`", $conexion) or die(mysql_error());
  ...
  <tr class="row" id="fila_<?php echo $i?>">    
    ...
    onChange="total('<?php echo $i?>')" required value="<?php echo $row_inv['cant_fisica']?>">
    <input type="hidden" id="fiso<?php echo $i?>" value="<?php echo $row_inv['cant_fisica'] ?>">
    </td>
  ...
  <textarea name="ta_coment" id="ta_coment" cols="" rows="2" class="long"><?php echo $row_cierre['obs']?></textarea>
  </td>
  </tr>
</table>
