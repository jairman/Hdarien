...
$(document).ajaxStop(function(){
	...
	console.log('f:'+fenca+' f1:'+ffact+' f2:'+ffact2+' d:'+fdiario+' fc:'+fdcons+' c:'+contador+' cb:'+contadorb+' c2:'+contador2+' c3:'+contador3)
	//console.log('-----Finish------')
	if (ffact == true && x == 0){
		createDiario();
		//updTarea();
	...
	if (fenca == true && ffact == true && fdiario == true && fdcons == true && ffact2 == true && x == 4){
		if(contador == contadorb && contador == contador2 && contador == contador3 ){
			//console.log('eureka');
			x++;	
			setTimeout(function () {
				//redirect();
	...
	$.ajax({
		...
		success:function(dato){
			...
			if (dato){
				...
				//console.log("consec="+consec+"&fecha="+fecha+"&user="+user2+"&prove="+prove+"&tel="+tel+"&ced="+ced+"&forma="+forma+"&fpago="+fpago+"&obs="+obs+"&costo="+costo+"&cant="+cant+"&action=new_fact2")
