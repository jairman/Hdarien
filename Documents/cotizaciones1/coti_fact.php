...
<table width="98%" align="center" id="table_header">
    ...
    <td align="right" width="10%" rowspan="3"><input type="image" title="Imprimir" src="../img/imprimir.png" alt="" 
    ...
    <tr>
      <td colspan="3" class="tittle" align="center">Registro de Cotización</td>
    </tr>
</table>
...
<table width="98%" border="1" cellspacing="0" align="center">
    ...
    <tr>
      ...
      <td align="center" class="cont"><label><? echo $row_fact['f_vig']?></label></td>
    </tr>
    <tr>
