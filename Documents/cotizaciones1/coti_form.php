...
<script src="js/coti_form.js" type="text/javascript"></script>
...
<form id="form1" name="form1">
    ...
    <tr>
      ...
      <label id="tf_consec" class="red" style="font-weight:bold; font-size:16px"><?php echo $factura?></label>
      </td>
    </tr>
    <tr>
      <td align="center">&nbsp;</td>
  ...
  <table width="98%" border="1" cellspacing="0" align="center">
    ...
    <tr>
      ...
      <td align="center" class="cont"><input type="text" id="tf_fvig" class="long" ></td>
    </tr>
    <tr>
      <td class="bold" >Observaciones</td>
      <td align="center" class="cont" colspan="3"><input type="text" name="tf_obs" id="tf_obs" style="width:95%" >
  ...
  <tr id="fila_<?php echo $i?>" class="row">  
    ...
    <input type="text" id="tf_ref<?php echo $i?>" class="ref long" required 
    onChange="checkref(<?php echo $i ?>)" >
    </td>
    <td class="cont">
    <input type="text" id="tf_desc<?php echo $i?>" class="long">
    </td>
    <td class="cont">
    <input type="text" id="tf_marca<?php echo $i?>" class="long" >
    </td>
    <td class="cont" align="center">
