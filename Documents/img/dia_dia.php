...
<table width="98%" border="1" align="center" cellspacing="0">
  <tr >
    <th width="201" align="left" >&nbsp;</th>
    <td width="157" align="center" >&nbsp;</td>
    <td width="173" align="center" >&nbsp;</td>
    <td width="257" align="center" >&nbsp;</td>
    <td width="98" align="center" ><img src="img/historial.png" width="40" height="40" onclick="histo()" title="Historial De Facturas" style="cursor:pointer" /></td>
    <td width="93" align="center" ><img src="img/pendientes.jpg" width="40" height="40" onclick="pendi()" title="Facturas Pendientes" style="cursor:pointer" /></td>
    <td width="88" align="center" ><img src="img/carrito.jpg" width="40" height="40" onclick="agre()"  title="Añadir Registro" style="cursor:pointer"/></td>
  </tr>
  <tr  class="tittle">
    <td >&nbsp;</td>
    ...
    <td ><?
      ...
      <? 
        ...
        ?>
      <input type="text" readonly="readonly" id="tf_hac" name="tf_hac" style="width:98%" value="<? echo $usuario2 ?>" />
      <?
        }
        ?></td>
    <td align="right" >&nbsp; </td>
...
<table width="98%" border="1" align="center" cellspacing="0">
  ...
  <tr align="center"  class="tittle">
    ...
    <td width="167" >Cliente/Proveedor</td>
    <td width="210" >Comentario</td>
    <td width="116" >Forma de Pago</td>
    <td width="89" >Concepto</td>
    <td width="81" >Valor Total</td>
 ...
 @ $eco =$row["fecha"];
   ?> 
  <tr  class="row" align="center" id="fila_<? echo $row_drio['factura']; ?>"  onMouseOver="ResaltarFila('fila_<? echo $row_drio['factura']; ?>');mano(this);" onMouseOut="RestablecerFila('fila_<? echo $row_drio['factura']; ?>')" onClick="CrearEnlace('factura_diario.php?id=<?php echo $row_drio['factura']; ?>&hda=<?php echo $row_drio['hacienda']; ?>');">
		 ...
		 if ($usuario2 == 'general'){
			if($hda !=''){ 
					$juli = mysql_query("SELECT SUM(`valor`) as total FROM d89xz_diario where `hacienda`='$hda' AND concep ='Ingreso'
								   ...
								   DAY(fecha) = '$dia' and estado !='Anulada'  and  estado !='Cancelada'  and devolucion !='3'  and  devolucion !='4'   and   f_pago !='Consignación'  and   f_pago !='Saldo'    ", $conexion);
			}else{
					$juli = mysql_query("SELECT SUM(`valor`) as total FROM d89xz_diario where  concep ='Ingreso'
					                and YEAR(fecha) ='$anoss' AND MONTH(fecha) = '$mess' AND 
								   DAY(fecha) = '$dia' and estado !='Anulada'  and  estado !='Cancelada'  and devolucion !='3'  and  devolucion !='4'   and   f_pago !='Consignación'  and   f_pago !='Saldo'   ", $conexion);
			 ...
			 $juli = mysql_query("SELECT SUM(`valor`) as total FROM d89xz_diario where `hacienda`='$usuario2' AND  concep ='Ingreso' and 
							 ...
							 estado !='Anulada'  and  estado !='Cancelada'  and devolucion !='3'  and  devolucion !='4'   and   f_pago !='Consignación'  and   f_pago !='Saldo'  ",$conexion);
