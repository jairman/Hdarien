...
<script src="../js/config_cat.js" type="text/javascript"></script>
  ...
  <tr>
    <td width="76%" align="left">
     <div id="menu">
      ...
      <li>
        <a href="../views/config_cat.php" class='active' >Categoría</a>
      </li>
      <li>
...
<table width="90%" border="1" cellspacing="0" align="center" id="tb_detail">
  ...
  <?php
	...
	$query_inv = mysql_query("SELECT * FROM `h01sg_categoria_prod` WHERE `delete`<>1 $order_url", $conexion) or die(mysql_error());		
