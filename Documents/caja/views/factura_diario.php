...
<script src="../js/factura_diario.js" type="text/javascript"></script>
...
<table width="100%" border="0" align="center" cellspacing="0">
  <tr bgcolor="#f0f0f0">
    <td width="1005" align="left">&nbsp;</td>
    <td width="68" align="center"><input name="imgb" type="image" src="../../img/mail.png" width="40" height="40" title="Enviar Email"  onclick="mostrar1('<?= $_GET['hda'] ?>','<?= $_GET['id'] ?>')" /></td>
    <td width="52" align="right"><img  title="Imprimir" src="../../img/imprimir.png" alt=""  width="40" height="40" border="0" align="right" style="cursor:pointer" onclick="imprimir_esto('seleccion')"/></td>
  </tr>
</table>
<DIV ID="seleccion">
  <table width="90%" border="0" align="center" cellspacing="0">
  <tr bgcolor="#FFFFFF">
    <td width="223" rowspan="3" valign="top"><img src="../../../img/Logo.png" align="baseline" width="200" height="70" />
      <p><?php echo $row_hd['empresa']; ?></p>
      NIT <?php echo $row_hd['nit']; ?></td>
    <td colspan="2" align="center"><?php echo $row_haci['empresa']; ?><p>Teléfono &nbsp; <?php echo $row_haci['telefono']; ?><p><?php echo ucwords(strtolower($row_haci['municipio'])); ?>- Colombia</td>
    <td colspan="2" rowspan="2" align="center"  class="bold" style="font-size: 16px" ><?PHP  if($row_fac['concep'] == 'Egreso'){ ?>
  ...
  <tr>
    ...
    <td colspan="2" bgcolor="#FFFFFF" class="cont"><?php echo $row_fac['cliente']; ?></td>
    <td width="186" bgcolor="#FFFFFF" class="bold" >FECHA</td>
    <td width="202" bgcolor="#FFFFFF" class="cont"><?php echo $row_fac['fecha']; ?></td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF" class="bold">CÉDULA/NIT</td>
    <td width="241" bgcolor="#FFFFFF" class="cont">
      <?php echo $row_fac['cedula']; ?> </td>
    <td width="145" bgcolor="#FFFFFF">&nbsp;</td>
    <td bgcolor="#FFFFFF" class="bold">TELÉFONO</td>
  ...
  <tr>
    <td bgcolor="#d8d8d8" class="bold">LA SUMA DE</td>
    <td align="left" bgcolor="#FFFFFF" class="cont"> $ <? echo number_format (abs($row["total"])) ?></td>
    <td bgcolor="#FFFFFF" >&nbsp;</td>
    <td bgcolor="#FFFFFF" class="bold">ESTADO</td>
    <td bgcolor="#FFFFFF" class="cont"><?php echo $row_fac['estado']; ?></td>
  </tr>
  </table>
