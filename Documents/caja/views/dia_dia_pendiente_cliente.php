...
<script src="../js/dia_dia_pendiente_cliente.js" type="text/javascript"></script>
...
<table width="95%" border="0" align="center" cellspacing="0">
  <tr >
    <td width="858" align="left" ><div id="menu">
     <ul >
      <ul>
        <li><a href="../../clientes/views/verClientes.php?id=<?= $idc_url ?>" >Información del Cliente</a></li>
        <li><a href="../../clientes/views/client_histo.php?id=<?= $idc_url ?>">Historial de Facturación</a></li>
        <li> <a href="dia_dia_pendiente_cliente.php?id=<?= $idc_url ?>"  class='active'>Cuentas Por Cobrar</a> </li>
...
<table width="99%" border="1" align="center" cellspacing="0" id="t_suma">
  ...
  do {
      ...
      <tr class="row" align="center" >
        <td   align="center" onClick="mostrar('fact.php?c=<?= $row_pen['consec_fact'] ?>&p=<?= $row_pen['hacienda'] ?>&factura=<?= $row_pen['factura'] ?>')"><?= $row_pen['fecha']; ?></td>
      <td   align="center" onClick="mostrar('fact.php?c=<?= $row_pen['consec_fact'] ?>&p=<?= $row_pen['hacienda'] ?>&factura=<?= $row_pen['factura'] ?>')"><?= $row_pen['factura']; ?></td>
      <td   align="center" onClick="mostrar('fact.php?c=<?= $row_pen['consec_fact'] ?>&p=<?= $row_pen['hacienda'] ?>&factura=<?= $row_pen['factura'] ?>')" ><?= $row_pen['hacienda']; ?></td>
      <td colspan="2"   align="center" onClick="mostrar('fact.php?c=<?= $row_pen['consec_fact'] ?>&p=<?= $row_pen['hacienda'] ?>&factura=<?= $row_pen['factura'] ?>')" >&nbsp;<?= $row_pen['f_alarma']; ?></td>   
      <td  align="center" onClick="mostrar('fact.php?c=<?= $row_pen['consec_fact'] ?>&p=<?= $row_pen['hacienda'] ?>&factura=<?= $row_pen['factura'] ?>')" ><?= $row_pen['comentario']; ?></td>
      <td  align="right" onClick="mostrar('fact.php?c=<?= $row_pen['consec_fact'] ?>&p=<?= $row_pen['hacienda'] ?>&factura=<?= $row_pen['factura'] ?>')"><?php 
...
<td   align="center" ><input name="imgb" type="image" src="../../img/mail.png" width="25" height="25" title="Enviar Email"  onClick="mostrar1('<?= $row_pen['consec_fact'] ?>','<?= $row_pen['hacienda'] ?>','<?= $row_pen['factura'] ?>')" /></td>
    </tr>
        <?php 
