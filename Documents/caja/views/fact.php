...
<table width="90%" align="center" id="tb_cdata">
  ...
  <tr>
    ...
    <td class="cont"><label><?= $row_dir['telefono']?></label></td>
  </tr>
  <tr>
  	<td class="bold">Forma de Pago</td>
    <td class="cont"><label><?= $row_fact['forma_pago']?></label></td>
    <td class="bold">Fecha Pago</td>
    <td class="cont"><label><?= $row_fact['fecha_p']?></label></td>
  </tr>
</table>
...
<table width="90%" align="center" id="tb_prod">
  ...
  <tr id="fila_<?= $i?>">
    ...
    <td class="cont">
    <label><?= number_format($row_prod['valor'], 2)?></label>
    </td>
    <td class="cont">
    <label><?= number_format($row_prod['dscto'], 2)?></label>
    </td>
    <td class="cont">
    <label><?= number_format($row_prod['total'], 2)?></label>
    </td> 
    <?php 
	$i++;
  }
...
<table width="90%" align="center" id="tb_cost">
  <tr align="center">
    ...
    <td width="30%" class="cont"><label class="red"><?= number_format($row_fact['dscto'], 2)?></label></td>
    <td width="20%" class="bold">SUBTOTAL</td>
    <td width="30%" class="cont"><label class="red"><?= number_format($row_fact['sub_total'], 2)?></label></td>
  </tr>
  <tr align="center">
    <td width="20%" class="bold">Items</td>
    <td width="30%" class="cont"><label id="lb_itemst" class="red"><?= $row_fact['total_items']?></label></td>
    <td width="20%" class="bold">IVA</td>
    <td width="30%" class="cont"><label class="red"><?= number_format($row_fact['iva'], 2)?></label></td>
  </tr>
  <tr  align="center">
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td align="center" class="bold">TOTAL</td>
    <td class="cont"><label id="lb_total" class="red"><?= number_format($row_fact['tot_final'], 2)?></label></td>
  </tr>
</table>
