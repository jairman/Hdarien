...
<script src="../js/dia_dia_pendiente.js" type="text/javascript"></script>
...
<DIV ID="seleccion">
  ...
  <table width="99%" border="1" align="center" cellspacing="0">
    <tr >
    <th colspan="2" align="left" ><img src="../../../img/Logo.png" alt="" width="201" height="74" /></th>
 ...
 $usuario_nivel;
	  if($usuario_nivel !='general'){
		...
		// echo $usuario_nivel;
					...
					if($hda !=' ' && $f2 !='' ) {
					//echo "1".$hda;
						$query_pen = "SELECT DISTINCT factura,cliente,estado,comentario,hacienda,f_pago,concep,f_alarma ,fecha,consec_fact  FROM d89xz_diario WHERE  estado = 'Pendiente' and   concep='Ingreso' and   hacienda='$hda'   and    fecha >= '$f1'  AND  fecha <='$f2'   ORDER BY factura desc"; 
				  }
...
<table width="99%" border="1" align="center" cellspacing="0" id="t_suma">
  ...
  do {
      ...
      <td   align="center" onClick="mostrar('fact.php?c=<?= $row_pen['consec_fact'] ?>&p=<?= $row_pen['hacienda'] ?>&factura=<?= $row_pen['factura'] ?>')" ><?= $row_pen['f_alarma']; ?></td>
      <td   align="center" onClick="mostrar('fact.php?c=<?= $row_pen['consec_fact'] ?>&p=<?= $row_pen['hacienda'] ?>&factura=<?= $row_pen['factura'] ?>')" >&nbsp; <?= $row_pen['cliente']; ?></td>   
