...
<table width="100%" border="0" align="center" cellspacing="0">
  <tr bgcolor="#f0f0f0">
    ...
    <td width="239" align="right"><input name="imgb" type="image"  title="Imprimir" src="../../img/imprimir.png" alt=""  width="40" height="40" border="0" align="right" style="cursor:pointer" onclick="imprimir_esto('seleccion')"/></td>
  </tr>
</table>
<DIV ID="seleccion">
  <table width="90%" border="0" align="center" cellspacing="0">
  <tr bgcolor="#FFFFFF">
    <td width="230" rowspan="4"><img src="../../../img/Logo.png" align="baseline" width="230" height="70" />
      <p><?php echo $row_hd['empresa']; ?>&nbsp;<p>NIT <?php echo $row_hd['nit']; ?></p></td>
    <td colspan="2" align="center">&nbsp;</td>
    <td colspan="2" align="left"  >&nbsp;</td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td colspan="2" align="center"><?php echo $row_haci['empresa']; ?></td>
