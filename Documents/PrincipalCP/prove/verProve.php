...
<table width="95%" align="center" id="table_header">
  <tr>
    ...
    <div id="menu">
      <ul>
      <li> <a href="../prove/verProve.php?id=<?php echo $colname_clien ?>" class='active'>Información del Provedor</a>
      </li>
      <li><a  href="../prove/compras_ini.php?id=<?php echo $colname_clien ?>">Historial de Facturación</a></li>
      <li> <a href="../../caja/dia_dia_pendiente_prove.php?id=<?php echo $colname_clien ?>"  >Cuentas Por Pagar</a> </li>
      </ul>
    </div>  
    </td>
...
<input type="hidden" name="registro" id="categoria" >
  ...
  <tr>
    ...
    <td class="cont"><input name="contacto" type="text" id="contacto3" style="width:98%" value="<?php echo $row_clien['forma']; ?>" readonly="readonly" /></td>
    <td class="bold">Tipo de Producto</td>
    <td class="cont"><input name="contacto2" type="text" id="contacto4" style="width:98%" value="<?php echo $row_clien['tipo']; ?>" readonly="readonly" /></td>
  </tr>
  </table>
