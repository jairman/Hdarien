...
<td width="5%" align="center"><img src="../../img/Excell_Up.png" alt="" width="40" height="40" style="cursor:pointer" title="Agregar Excel"  onclick="agregar_excel()"  /></td>
   ...
   <?php
	...
	$query_kar = "SELECT * FROM d89xz_prove where `delete` !='1' order by  nombre ";
...
<table width="98%" border="1" align="center" cellspacing="0">
  ...
  <?php do { ?>
    <tr class="row" title="Ver Detalle">
      ...
      <td align="center" onClick="mostrar('<?php echo $row_kar['id'];  ?>');"><?php echo $row_kar['contacto1']; ?></td>
      ...
      <td align="center" onClick="mostrar('<?php echo $row_kar['id'];  ?>');" ><?php echo $row_kar['tipo']; ?></td>
      <td width="4%" align="center" onClick="mostrar1('<?php echo $row_kar['id'];  ?>');">
...
function eliminar(idn){
	//alert(idn)
	overlay.show()
	$("#dialog2").html('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   Eliminar Proveedor&nbsp;&nbsp;&nbsp;&nbsp;    ').css('text-align','center');
