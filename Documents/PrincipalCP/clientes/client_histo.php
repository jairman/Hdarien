...
<table width="95%" align="center" id="table_header">
  <tr>
    ...
    <div id="menu">
      <ul>
      <li>
      <a href="../clientes/verClientes.php?id=<?php echo $idc_url ?>" >Información del Cliente</a>
      </li>
      <li>
      <a  href="../clientes/client_histo.php?id=<?php echo $idc_url ?>" class='active'>Historial de Facturación</a>
      </li>
      <li>
      <a  href="../../caja/dia_dia_pendiente_cliente.php?id=<?php echo $idc_url ?>" >Cuentas Por Cobrar</a>
      </li>
      </ul>
    </div>  
    </td>
