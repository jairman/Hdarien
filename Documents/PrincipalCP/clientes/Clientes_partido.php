...
?>
  ...
  <tr>
    <td colspan="5" align="center" ><input type="submit" name="button1" id="button1" value="Siguiente"  onclick="primero(); return false" class="ext" style="width:150px"/></td>
  </tr>
</table>
...
<table width="90%" border="1" align="center" cellspacing="0">
  ...
  <tr>
    <td colspan="4" align="center"><input name="button3" type="submit" class="ext" id="button3" value="Atrás"  style="width:150px" onclick="cuarto(); return false"/>   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   
