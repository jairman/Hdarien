...
function load1(ptov){
	...
	$('#d_table').load('invent_ini.php?p=' + ptov.replace(/ /g,"+")  + '&m=' + marca.replace(/ /g,"+") + '&o=' + o.replace(/ /g,"+")  + ' #d_table ', 
...
function load3(order){
	...
	var marca = $('#sl_marca').val();
	//console.log ('h:'+hac+' y:'+y+' m:'+m+' d:'+d);	
	$('#d_table').load('invent_ini.php?p=' + ptov.replace(/ /g,"+") + '&m=' + marca.replace(/ /g,"+") + '&o=' + order.replace(/ /g,"+")  + ' #d_table ', 
	function(response, status, xhr){
		//console.log('r:'+response+' s:'+status+' x: '+xhr);
		//console.log(status);	
		if (status == 'success'){
