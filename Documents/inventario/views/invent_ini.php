...
<script src="../js/invent_ini.js" type="text/javascript"></script>
...
<table width="90%" align="center" id="table_header">
  <tr>
    ...
    <div id="menu">
      <ul>
      <li>
      <a href="invent_ini.php" class='active'>Reporte de Inventario</a>
      </li>
      <li>
      <a  href="invent_ini2.php">Reporte de Productos Vendidos</a>
      </li>
      <li>
    ...
    <!--<input type="image" src="../img/sort.png" alt="" width="48" height="48" border="0" align="right"  
    title="Movimientos de Inventario" id="bt_addi" style="cursor:pointer" >-->
