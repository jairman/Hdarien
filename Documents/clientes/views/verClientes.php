...
<td class="cont"><input name="contacto" type="text" id="contacto3" style="width:98%" value="<?= $row_clien['cumple']; ?>" readonly="readonly" /></td>
<td class="bold">Saldo a Favor</td>
<td class="cont"><input name="contacto2" type="text" id="contacto4" style="width:98%" value="<?= $row_clien['saldo_favor']; ?>" readonly="readonly" /></td>
</tr>
<tr>
<td class="bold">Tipo Cliente</td>
<td class="cont"><input name="contacto3" type="text" id="contacto2" style="width:98%" value="<?= $row_clien['formapago']; ?>" readonly="readonly" /></td>
<td class="bold">&nbsp;</td>
<td class="cont">&nbsp;</td>
</tr>
  <tr>
