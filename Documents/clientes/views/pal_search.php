...
<?php require_once('../../Connections/conexion.php'); 
      require_once('../controllers/priorySearch.php');
 ?>
...
?>
 ...
 <tr class="row"  title="Ver Detalle">
  <td width="13%" align="center" onClick="mostrar('<?= $row_rs_anims['id'];?>');"><?= $final_cedula; ?></td>
  <td width="25%" align="center" onClick="mostrar('<?= $row_rs_anims['id'];?>');"><?= $final_nombre; ?></td>
  <td width="9%" align="center" onClick="mostrar('<?= $row_rs_anims['id'];?>');"><?= $final_forma; ?></td>
  <td width="11%" align="center" onClick="mostrar('<?= $row_rs_anims['id'];?>');"><?= $final_celular;?></td>
  <td width="16%" align="center" onClick="mostrar('<?= $row_rs_anims['id'];  ?>');"><?= $final_cate; ?></td>
  <td width="0%" align="center" onClick="mostrar('<?= $row_rs_anims['id'];?>');" ><?= $final_ciudad2;?></td>
  <td width="0%" align="center" onClick="mostrar('<?= $row_rs_anims['id'];?>');" ><?= $final_ciudad; ?></td>     
  <td width="4%" align="center" onClick="mostrar1('<?= $row_rs_anims['id'];  ?>');">
        ...
        <td width="2%" align="center" onClick="eliminar('<?= $row_rs_anims['id'];  ?>');">
   ...
   <?php } ?> 
      ...
      <input type="hidden" id="totalR" value="<?= $nreg ?>" />         