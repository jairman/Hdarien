...
<script src="../js/ped_edit.js" type="text/javascript"></script>
</head>
...
<form id="form1" name="form1">
    ...
    <tr>
      ...
      <label class="red" style="font-weight:bold; font-size:16px" id="tf_consec"><? echo $consec_url?></label>
      </td>
    </tr>
    <tr>
      <td align="center">&nbsp;</td>
  ...
  <table width="98%" border="1" cellspacing="0" align="center">
    <tr>
      ...
      <td width="30%" class="cont"><input name="tf_fecha" type="text" 
    ...
    <tr>
      ...
      <td align="center" class="cont">
      <input type="text" id="tf_cot" class="long" readonly value="<?php echo $row_fact['cot']?>">
      </td>
    </tr>
    <tr>
      <td class="bold" >Fecha Entrega</td>
      <td align="center" class="cont">
      <input name="tf_fdesp" type="text" class="long" id="tf_fdesp" value="<?php echo $row_fact['f_despacho']?>">
      </td>
      <td class="bold" >Observaciones</td>
      <td align="center" class="cont"><input name="tf_obs" type="text" style="width:80%" 
