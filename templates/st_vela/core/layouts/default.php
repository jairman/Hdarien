...
<html lang="<?php echo $template->language; ?>" dir="<?php echo $template->direction; ?>" >
	...
	<body id="avatar-template" class="<?php echo ($this->_responsive) ? 'avatar-responsive' : ''; echo ($template->params->get('css3_effect')) ? ' css3-effect ' : ''; echo ' '.$this->getMenuClass(); ?>">
		...
		<div class="clearfix">
			...
			<?php endif; ?>
			<?php if ($posHeaderBottom): ?>
				<div id="avatar-header-bottom-block">
					<div class="avatar-wrapper <?php echo $template->params->get('avatar_header_bottom_block'); ?>">
						<jdoc:include type="modules" name="header-bottom" style="avatarmodule" />
					</div>
				</div>
			<?php endif; ?>
			...
			<?php if ($posPromoTopLeft || $posPromoTopMiddle || $posPromoTopRight || $posUser10 || $posUser8 || $posUser9 || $posContentTop 
						|| $posUser11 || $posUser12 || $posUser13 || $posUser14 || $posUser21 || $posUser22) :?>
				<div id="avatar-body-top-block">
					...
					<?php if ($posUser21 || $posUser22): ?>
						<div id="avatar-user-top-col-2">
							<?php if ($posUser21): ?>
			...
			<?php if ($template->countModules('full-1-example')): ?>
						<div id="avatar-full-1-example-block">
							<div class="avatar-wrapper1 <?php echo $template->params->get('avatar_full_1_example_block'); ?>">
								<jdoc:include type="modules" name="full-1-example" style="avatarmodule" />
							</div>
						</div>
					<?php endif; ?>
			...
			<?php if ($template->countModules('full-4-example')): ?>
				<div id="avatar-full-4-example-block">
					<div class="avatar-wrapper <?php echo $template->params->get('avatar_full_4_example_block'); ?>">
						<jdoc:include type="modules" name="full-4-example" style="avatarmodule" />
					</div>
				</div>
			<?php endif; ?>
			...
			<?php if ($posUser19 || $posUser20) :?>
				<div id="avatar-body-bottom-block1">
					<div class="avatar-wrapper <?php echo $template->params->get('avatar_body_bottom_block'); ?>">					
					<?php if ($posUser19 || $posUser20): ?>
			...
			<?php if ($template->countModules('full-6-example')): ?>
						<div id="avatar-full-6-example-block">
							<div class="avatar-wrapper1 <?php echo $template->params->get('avatar_full_6_example_block'); ?>">
								<jdoc:include type="modules" name="full-6-example" style="avatarmodule" />
							</div>
						</div>
					<?php endif; ?>
