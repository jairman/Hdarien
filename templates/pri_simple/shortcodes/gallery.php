...
if(!function_exists('gallery_sc')) {
	...
	function gallery_sc( $atts, $content="" ){
		...
		<div class="gallery-filters">
			<a class="btn active btn-primary" href="#" data-filter="*"><?php echo JText::_('Show All'); ?></a>
		...
		<ul class="gallery">
			<?php foreach ($galleryArray as $key=>$item) { ?>	
				...
				<div id="modal-<?php echo $key; ?>" class="modal hide fade" tabindex="-1">
					<a class="close-modal" href="javascript:;" data-dismiss="modal" aria-hidden="true"><i class="fa fa-remove"></i></a>
				...
				window.addEvent('load', function(){
					...
					$filter.find('>a').click(function(){
						var selector = $(this).attr('data-filter');
							...
							$selectors.removeClass('active btn-primary');
